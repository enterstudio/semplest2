 ...
 */
            ...
            /**
            *  TimeIntervalE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TimeIntervalE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localTimeInterval==null){
                                        ...
                                        writeStartElement(null, namespace, "TimeInterval", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localTimeInterval.serialize(MY_QNAME,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localTimeInterval==null){
                                   ...
                                   return localTimeInterval.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static TimeIntervalE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TimeIntervalE object =
                new TimeIntervalE();
            ...
            try {
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/Microsoft.AdCenter.Advertiser.CampaignManagement.Api.DataContracts","TimeInterval").equals(reader.getName())){
