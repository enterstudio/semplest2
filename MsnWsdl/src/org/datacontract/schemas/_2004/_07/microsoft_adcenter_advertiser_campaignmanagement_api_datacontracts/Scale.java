 ...
 */
                ...
                "ns2");
                        ...
                        */
                            ...
                            // Constructor
                                ...
                                protected Scale(java.lang.String value, boolean isRegisterValue) {
                                    localScale = value;
                                    if (isRegisterValue){
                                        
                                               _table_.put(localScale, this);
                                           
                                    }

                                }
                            
                                    public static final java.lang.String _Minimal =
                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToString("Minimal");
                                    ...
                                    public static final java.lang.String _VeryHigh =
                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToString("VeryHigh");
                                
                                public static final Scale Minimal =
                                    new Scale(_Minimal,true);
                            
                                public static final Scale Low =
                                    new Scale(_Low,true);
                            
                                public static final Scale Medium =
                                    new Scale(_Medium,true);
                            
                                public static final Scale High =
                                    new Scale(_High,true);
                            
                                public static final Scale VeryHigh =
                                    new Scale(_VeryHigh,true);
                            

                                public java.lang.String getValue() { return localScale;}

                                public boolean equals(java.lang.Object obj) {return (obj == this);}
                                public int hashCode() { return toString().hashCode();}
                                public java.lang.String toString() {
                                
                                        return localScale.toString();
    ...
    public static class Factory{
                ...
                public static Scale fromString(java.lang.String value,java.lang.String namespaceURI)
                      throws java.lang.IllegalArgumentException {
                    try {
                ...
                public static Scale fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return Scale.Factory.fromString(content,namespaceUri);
                    } else {
                       return Scale.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static Scale parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Scale object = null;
                    ...
                    if (reader.isStartElement()  || reader.hasText()){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        if (content.indexOf(":") > 0) {
                                            ...
                                            object = Scale.Factory.fromString(content,namespaceuri);
                                        } else {
                                            // this seems to be not a qname send and empty namespace incase of it is
                                            // check is done in fromString method
                                            object = Scale.Factory.fromString(content,"");
                                        }
