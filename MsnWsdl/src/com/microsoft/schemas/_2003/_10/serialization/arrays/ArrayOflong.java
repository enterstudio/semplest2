 ...
 */
                ...
                if (local_longTracker){
                             if (local_long!=null) {
                                   ...
                                   for (int i = 0;i < local_long.length;i++){
                                                   ...
                                                   if (local_long[i]!=java.lang.Long.MIN_VALUE) {
                                               
                                                writeStartElement(null, namespace, "long", xmlWriter);

                                            
                                                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(local_long[i]));
                            ...
                            if (local_long!=null){
                                  for (int i = 0;i < local_long.length;i++){
                                          ...
                                          elementList.add(new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays",
                                                                                                                       "long"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(local_long[i]));
    ...
    public static class Factory{
        ...
        */
        public static ArrayOflong parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ArrayOflong object =
                new ArrayOflong();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ArrayOflong".equals(type)){
                                ...
                                return (ArrayOflong)com.microsoft.adcenter.v8.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays","long").equals(reader.getName())){
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays","long").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
