 ...
 */
            ...
            /**
            *  GetEstimatedPositionByKeywordsRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns4");
                        ...
                        */
                                    ...
                                    protected double localMaxBid ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMaxBidTracker = false ;

                           public boolean isMaxBidSpecified(){
                               return localMaxBidTracker;
                           }
                           ...
                           */
                           public  double getMaxBid(){
                            ...
                            /**
                               ...
                               * @param param MaxBid
                               */
                               public void setMaxBid(double param){
                            
                                       // setting primitive attribute tracker to true
                                       localMaxBidTracker =
                                       !java.lang.Double.isNaN(param);
                                   
                                            this.localMaxBid=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetEstimatedPositionByKeywordsRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetEstimatedPositionByKeywordsRequest",
                ...
                if (localKeywordsTracker){
                                ...
                                } if (localMaxBidTracker){
                                    namespace = "https://adcenter.microsoft.com/v8";
                                    writeStartElement(null, namespace, "MaxBid", xmlWriter);
                             
                                               if (java.lang.Double.isNaN(localMaxBid)) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("MaxBid cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaxBid));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localKeywordsTracker){
                            elementList.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMaxBid));
                            } if (localLanguageTracker){
                                      elementList.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8",
                                                                      "Language"));
    ...
    public static class Factory{
        ...
        */
        public static GetEstimatedPositionByKeywordsRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetEstimatedPositionByKeywordsRequest object =
                new GetEstimatedPositionByKeywordsRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetEstimatedPositionByKeywordsRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetEstimatedPositionByKeywordsRequest)com.microsoft.adcenter.v8.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8","MaxBid").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"MaxBid" +"  cannot be null");
                                    }
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        reader.next();
                                               ...
                                               object.setMaxBid(java.lang.Double.NaN);
