...
/**
 * DeleteTargetFromCampaignRequest.java
 *
 ...
 */
            ...
            /**
            *  DeleteTargetFromCampaignRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "DeleteTargetFromCampaignRequest",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteTargetFromCampaignRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeleteTargetFromCampaignRequest",
    ...
    public static class Factory{
        ...
        */
        public static DeleteTargetFromCampaignRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteTargetFromCampaignRequest object =
                new DeleteTargetFromCampaignRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteTargetFromCampaignRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteTargetFromCampaignRequest)com.microsoft.adcenter.v8.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
