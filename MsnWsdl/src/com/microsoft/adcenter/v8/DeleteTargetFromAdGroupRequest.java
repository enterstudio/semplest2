...
/**
 * DeleteTargetFromAdGroupRequest.java
 *
 ...
 */
            ...
            /**
            *  DeleteTargetFromAdGroupRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "DeleteTargetFromAdGroupRequest",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteTargetFromAdGroupRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeleteTargetFromAdGroupRequest",
    ...
    public static class Factory{
        ...
        */
        public static DeleteTargetFromAdGroupRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteTargetFromAdGroupRequest object =
                new DeleteTargetFromAdGroupRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteTargetFromAdGroupRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteTargetFromAdGroupRequest)com.microsoft.adcenter.v8.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
