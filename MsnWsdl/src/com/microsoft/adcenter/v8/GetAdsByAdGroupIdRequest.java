 ...
 */
            ...
            /**
            *  GetAdsByAdGroupIdRequest bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAdsByAdGroupIdRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAdsByAdGroupIdRequest",
    ...
    public static class Factory{
        ...
        */
        public static GetAdsByAdGroupIdRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAdsByAdGroupIdRequest object =
                new GetAdsByAdGroupIdRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAdsByAdGroupIdRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAdsByAdGroupIdRequest)com.microsoft.adcenter.v8.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
