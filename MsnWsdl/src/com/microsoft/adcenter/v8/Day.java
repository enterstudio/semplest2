 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns4");
                        ...
                        */
                                    ...
                                    protected java.lang.String localDay ;
                                
                            private static java.util.HashMap _table_ = new java.util.HashMap();

                            // Constructor
                            
                                protected Day(java.lang.String value, boolean isRegisterValue) {
                                    localDay = value;
                                    if (isRegisterValue){
                                        
                                               _table_.put(localDay, this);
                                ...
                                public static final Day Sunday =
                                    new Day(_Sunday,true);
                            
                                public static final Day Monday =
                                    new Day(_Monday,true);
                            
                                public static final Day Tuesday =
                                    new Day(_Tuesday,true);
                            
                                public static final Day Wednesday =
                                    new Day(_Wednesday,true);
                            
                                public static final Day Thursday =
                                    new Day(_Thursday,true);
                            
                                public static final Day Friday =
                                    new Day(_Friday,true);
                            
                                public static final Day Saturday =
                                    new Day(_Saturday,true);
                            

                                public java.lang.String getValue() { return localDay;}
                                       ...
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                          ...
                                          if (localDay==null){
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("Day cannot be null !!");
                                                       ...
                                                       xmlWriter.writeCharacters(localDay);
    ...
    public static class Factory{
                ...
                public static Day fromString(java.lang.String value,java.lang.String namespaceURI)
                      throws java.lang.IllegalArgumentException {
                    try {
                ...
                public static Day fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return Day.Factory.fromString(content,namespaceUri);
                    } else {
                       return Day.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static Day parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Day object = null;
                    ...
                    if (reader.isStartElement()  || reader.hasText()){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        if (content.indexOf(":") > 0) {
                                            ...
                                            object = Day.Factory.fromString(content,namespaceuri);
                                        } else {
                                            // this seems to be not a qname send and empty namespace incase of it is
                                            // check is done in fromString method
                                            object = Day.Factory.fromString(content,"");
                                        }
