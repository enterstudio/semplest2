 ...
 */
            ...
            /**
            *  ExpiredInsertionOrderNotification bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ExpiredInsertionOrderNotification extends com.microsoft.adcenter.api.notifications.entities.AccountNotification
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ExpiredInsertionOrderNotification
                ...
                */
                        ...
                        /**
                        * field for BillToCustomerName
                        */

                        
                                    protected java.lang.String localBillToCustomerName ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBillToCustomerNameTracker = false ;

                           public boolean isBillToCustomerNameSpecified(){
                               return localBillToCustomerNameTracker;
                           }
                           ...
                           */
                           public  java.lang.String getBillToCustomerName(){
                               return localBillToCustomerName;
                           }
                            ...
                            /**
                               ...
                               * @param param BillToCustomerName
                               */
                               public void setBillToCustomerName(java.lang.String param){
                            localBillToCustomerNameTracker = true;
                                   
                                            this.localBillToCustomerName=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ExpiredInsertionOrderNotification",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localNotificationIdTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localBillToCustomerNameTracker){
                                    namespace = "https://adcenter.microsoft.com/api/notifications/Entities";
                                    writeStartElement(null, namespace, "BillToCustomerName", xmlWriter);
                             

                                          if (localBillToCustomerName==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localBillToCustomerName);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/notifications/Entities","ExpiredInsertionOrderNotification"));
                 if (localNotificationIdTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAccountId));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/notifications/Entities",
                                         ...
                                         elementList.add(localBillToCustomerName==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBillToCustomerName));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static ExpiredInsertionOrderNotification parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ExpiredInsertionOrderNotification object =
                new ExpiredInsertionOrderNotification();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ExpiredInsertionOrderNotification".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ExpiredInsertionOrderNotification)com.microsoft.adcenter.api.notifications.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/notifications/Entities","BillToCustomerName").equals(reader.getName())){
