 ...
 */
            ...
            /**
            *  EditorialRejectionNotification bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EditorialRejectionNotification extends com.microsoft.adcenter.api.notifications.entities.AccountNotification
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = EditorialRejectionNotification
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EditorialRejectionNotification",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/notifications/Entities","EditorialRejectionNotification"));
                 if (localNotificationIdTracker){
    ...
    public static class Factory{
        ...
        */
        public static EditorialRejectionNotification parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EditorialRejectionNotification object =
                new EditorialRejectionNotification();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EditorialRejectionNotification".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EditorialRejectionNotification)com.microsoft.adcenter.api.notifications.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
