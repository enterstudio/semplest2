 ...
 */
            ...
            /**
            *  LowBudgetBalanceNotification bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LowBudgetBalanceNotification extends com.microsoft.adcenter.api.notifications.entities.AccountNotification
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = LowBudgetBalanceNotification
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.microsoft.adcenter.api.notifications.entities.ArrayOfLowBudgetBalanceCampaignInfo localAffectedCampaigns ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.microsoft.adcenter.api.notifications.entities.ArrayOfLowBudgetBalanceCampaignInfo getAffectedCampaigns(){
                            ...
                            /**
                               ...
                               */
                               public void setAffectedCampaigns(com.microsoft.adcenter.api.notifications.entities.ArrayOfLowBudgetBalanceCampaignInfo param){
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":LowBudgetBalanceNotification",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/notifications/Entities","LowBudgetBalanceNotification"));
                 if (localNotificationIdTracker){
    ...
    public static class Factory{
        ...
        */
        public static LowBudgetBalanceNotification parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LowBudgetBalanceNotification object =
                new LowBudgetBalanceNotification();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LowBudgetBalanceNotification".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LowBudgetBalanceNotification)com.microsoft.adcenter.api.notifications.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/notifications/Entities","CustomerId").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setAffectedCampaigns(com.microsoft.adcenter.api.notifications.entities.ArrayOfLowBudgetBalanceCampaignInfo.Factory.parse(reader));
