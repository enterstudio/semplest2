 ...
 */
            ...
            /**
            *  CustomerLifeCycleStatusE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CustomerLifeCycleStatusE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localCustomerLifeCycleStatus==null){
                                        ...
                                        writeStartElement(null, namespace, "CustomerLifeCycleStatus", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localCustomerLifeCycleStatus.serialize(MY_QNAME,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localCustomerLifeCycleStatus==null){
                                   ...
                                   return localCustomerLifeCycleStatus.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static CustomerLifeCycleStatusE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CustomerLifeCycleStatusE object =
                new CustomerLifeCycleStatusE();
