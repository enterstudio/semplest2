 ...
 */
            ...
            /**
            *  SendRequestToStopManagingAccountsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SendRequestToStopManagingAccountsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SendRequestToStopManagingAccountsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SendRequestToStopManagingAccountsResponse",
    ...
    public static class Factory{
        ...
        */
        public static SendRequestToStopManagingAccountsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SendRequestToStopManagingAccountsResponse object =
                new SendRequestToStopManagingAccountsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SendRequestToStopManagingAccountsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SendRequestToStopManagingAccountsResponse)com.microsoft.adcenter.api.customermanagement.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement","RequestId").equals(reader.getName())){
