 ...
 */
            ...
            /**
            *  GetUsersInfoRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns9");
                        ...
                        */
                        ...
                        /**
                        * field for StatusFilter
                        */

                        
                                    protected com.microsoft.adcenter.api.customermanagement.entities.UserLifeCycleStatus localStatusFilter ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localStatusFilterTracker = false ;

                           public boolean isStatusFilterSpecified(){
                               return localStatusFilterTracker;
                           }
                           ...
                           */
                           public  com.microsoft.adcenter.api.customermanagement.entities.UserLifeCycleStatus getStatusFilter(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param StatusFilter
                               */
                               public void setStatusFilter(com.microsoft.adcenter.api.customermanagement.entities.UserLifeCycleStatus param){
                            localStatusFilterTracker = true;
                                   
                                            this.localStatusFilter=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetUsersInfoRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetUsersInfoRequest",
                ...
                if (localCustomerIdTracker){
                             ...
                             } if (localStatusFilterTracker){
                                    if (localStatusFilter==null){

                                        writeStartElement(null, "https://adcenter.microsoft.com/api/customermanagement", "StatusFilter", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localStatusFilter.serialize(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement","StatusFilter"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localCustomerIdTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement",
                                    ...
                                    elementList.add(localStatusFilter==null?null:
                                    localStatusFilter);
                                }
    ...
    public static class Factory{
        ...
        */
        public static GetUsersInfoRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUsersInfoRequest object =
                new GetUsersInfoRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetUsersInfoRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUsersInfoRequest)com.microsoft.adcenter.api.customermanagement.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement","StatusFilter").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setStatusFilter(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setStatusFilter(com.microsoft.adcenter.api.customermanagement.entities.UserLifeCycleStatus.Factory.parse(reader));
