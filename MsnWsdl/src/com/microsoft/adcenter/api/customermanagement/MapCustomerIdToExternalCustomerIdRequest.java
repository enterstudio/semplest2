...
/**
 * MapCustomerIdToExternalCustomerIdRequest.java
 *
 ...
 */
            ...
            /**
            *  MapCustomerIdToExternalCustomerIdRequest bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns9");
                        ...
                        */
                        ...
                        /**
                        * field for ExternalCustomerId
                        */

                        
                                    protected java.lang.String localExternalCustomerId ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localExternalCustomerIdTracker = false ;

                           public boolean isExternalCustomerIdSpecified(){
                               return localExternalCustomerIdTracker;
                           }
                           ...
                           */
                           public  java.lang.String getExternalCustomerId(){
                               return localExternalCustomerId;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ExternalCustomerId
                               */
                               public void setExternalCustomerId(java.lang.String param){
                            localExternalCustomerIdTracker = true;
                                   
                                            this.localExternalCustomerId=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MapCustomerIdToExternalCustomerIdRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "MapCustomerIdToExternalCustomerIdRequest",
                ...
                if (localCustomerIdTracker){
                             ...
                             } if (localExternalCustomerIdTracker){
                                    namespace = "https://adcenter.microsoft.com/api/customermanagement";
                                    writeStartElement(null, namespace, "ExternalCustomerId", xmlWriter);
                             

                                          if (localExternalCustomerId==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localExternalCustomerId);
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCustomerId));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement",
                                         ...
                                         elementList.add(localExternalCustomerId==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localExternalCustomerId));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static MapCustomerIdToExternalCustomerIdRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MapCustomerIdToExternalCustomerIdRequest object =
                new MapCustomerIdToExternalCustomerIdRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MapCustomerIdToExternalCustomerIdRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MapCustomerIdToExternalCustomerIdRequest)com.microsoft.adcenter.api.customermanagement.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement","ExternalCustomerId").equals(reader.getName())){
