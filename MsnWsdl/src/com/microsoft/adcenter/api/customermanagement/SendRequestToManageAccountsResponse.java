 ...
 */
            ...
            /**
            *  SendRequestToManageAccountsResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SendRequestToManageAccountsResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SendRequestToManageAccountsResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SendRequestToManageAccountsResponse",
    ...
    public static class Factory{
        ...
        */
        public static SendRequestToManageAccountsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SendRequestToManageAccountsResponse object =
                new SendRequestToManageAccountsResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SendRequestToManageAccountsResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SendRequestToManageAccountsResponse)com.microsoft.adcenter.api.customermanagement.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
