...
public class GetTrafficEstimatorGoogle {
	...
	public static void main(String args[]) throws Exception{
		...
		lines.addAll(g.storeTrafficEstimatorDataGoogle("bridal hair style", KeywordMatchType.EXACT, bids));
		lines.addAll(g.storeTrafficEstimatorDataGoogle("bridesmaid hairstyles", KeywordMatchType.BROAD, bids));
		ReportUtils.saveArrayListString(lines, "/semplest/data/dailyReportObjects/WeddingHairReduced/TrafficEstimator.csv");
	}
