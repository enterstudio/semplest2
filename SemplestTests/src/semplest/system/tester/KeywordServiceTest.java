...
public class KeywordServiceTest implements SemplestKeywordLDAServiceInterface
{
	...
	public KeywordProbabilityObject[] getKeywords(List<String> categories, String companyName, AdEngine[] searchEngines, String searchTerm, String description, String[] adds, String url, GeoTargetObject[] gt, Integer[] nGrams) throws Exception
	{
		...
		long start = System.currentTimeMillis();
		SystemTestFunc.PrintMethodCall("getKeywords(selectCateg,null, SystemTestDataModel.keyword_AdEngineList, " + "SystemTestDataModel.keyword_SearchTerm, SystemTestDataModel.keyword_Description, null, SystemTestDataModel.keyword_LandingPage, null ,SystemTestDataModel.keyword_nGramsList)");
		try
		{
			kw = keywordService.getKeywords(selectCateg, null, SystemTestDataModel.keyword_AdEngineList, SystemTestDataModel.keyword_SearchTerm, SystemTestDataModel.keyword_Description, null, SystemTestDataModel.keyword_LandingPage, null, SystemTestDataModel.keyword_nGramsList);
		}
		catch (Exception e)
		{
			SystemTestFunc.ErrorHandler(e);
