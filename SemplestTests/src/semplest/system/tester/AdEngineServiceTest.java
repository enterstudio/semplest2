...
public class AdEngineServiceTest extends BaseDB implements SemplestAdengineServiceInterface
{
	...
	public Boolean AddAds(Integer promotionID, List<Integer> promotionAdIds, List<AdEngine> adEngines) throws Exception
	{
		...
		for (SystemTestDataModel.AD ad : SystemTestDataModel.promotionAds2)
		{
			...
			Integer id = jdbcTemplate.queryForInt(sql, new Object[] { SystemTestDataModel.semplestPromotionId, ad.adTitle });
	...
	public Boolean UpdateAds(Integer promotionID, List<Integer> promotionAdIds, List<AdEngine> adEngines) throws Exception
	{
		...
		jdbcTemplate.update(sql, new Object[] { newAdTitle, SystemTestDataModel.promotionAdIds2.get(0) });
	...
	public List<GoogleViolation> validateGoogleAd(String landingPageURL, String displayURL, List<GoogleAddAdRequest> ads) throws Exception
	{
		...
		SystemTestDataModel.adEngine_validateGoogleAds = new ArrayList<GoogleAddAdRequest>(Arrays.asList(new GoogleAddAdRequest(SystemTestDataModel.promotionAdIds.get(0), SystemTestDataModel.ad1.adTitle, SystemTestDataModel.ad1.adTextLine1, SystemTestDataModel.ad1.adTextLine2)));
	...
	private void Verification_AddPromotionToAdEngine() throws Exception
	{
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.Google))
		{
			...
			if (match != 1)
			{
				SystemTestFunc.ErrorHandler("Ads are not created correctly on google. " + "An Ad title '" + finaATitle + "' is not found.");
			}
			if (gads.length != SystemTestDataModel.promotionAds.size())
			{
				// verify the num of Ads get added
				SystemTestFunc.ErrorHandler("The num of Ads in database and the num of Ads be created on google don't match. " + "Num of active Ads in database: " + SystemTestDataModel.promotionAds.size() + ". Num of Ads added to google: " + gads.length);
			}
			...
			if (match != 1)
			{
				SystemTestFunc.ErrorHandler("Keywords are not created correctly on google. " + "An Keyword '" + findAKeyword + "' is not found.");
			}
			if (gkws.length != SystemTestDataModel.keywords.size())
			{
				// verify the num of Keywords get added
				SystemTestFunc.ErrorHandler("Not all Keywords in database are created on google. " + "Num of Keywords in database: " + SystemTestDataModel.keywords.size() + ". Num of Keywords added to google: " + gkws.length);
			}
			...
			if (match != 1)
			{
				SystemTestFunc.ErrorHandler("Negative Keywords are not created correctly on google. " + "A Negative Keyword '" + findANegKeyword + "' is not found.");
			}
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.MSN))
		{
			...
			if (match != 1)
			{
				SystemTestFunc.ErrorHandler("Ads are not created correctly on MSN. " + "An Ad title '" + finaATitle + "' is not found.");
			}
			if (mads.length != SystemTestDataModel.promotionAds.size())
			{
				// verify the num of Ads get added
				SystemTestFunc.ErrorHandler("The num of Ads in database and the num of Ads be created on MSN don't match. " + "Num of active Ads in database: " + SystemTestDataModel.promotionAds.size() + ". Num of Ads added to google: " + mads.length);
			}
			...
			if (match != 1)
			{
				SystemTestFunc.ErrorHandler("Keywords are not created correctly on MSN. " + "An Keyword '" + findAKeyword + "' is not found.");
			}
			if (mkws.length != SystemTestDataModel.keywords.size())
			{
				// verify the num of Keywords get added
				SystemTestFunc.ErrorHandler("Not all Keywords in database are created on MSN. " + "Num of Keywords in database: " + SystemTestDataModel.keywords.size() + ". Num of Ads added to MSN: " + mkws.length);
			}
			...
			// com.microsoft.adcenter.v8.Target mTarget = msn.getCampaignTargets(SystemTestDataModel.msnAccountId, SystemTestDataModel.msnCustomerId,
			// SystemTestDataModel.msnCampaignId);
	...
	private void Verification_AddAds() throws Exception
	{
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.Google))
		{
			...
			{
				// verify the num of Ads get added
				SystemTestFunc.ErrorHandler("The num of Ads in database and the num of Ads be created on google don't match. " + "Num of active Ads in database: " + numAllAds + ". Num of Ads added to google: " + gads.length);
			}
		}
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.MSN))
		{
			...
			{
				// verify the num of Ads get added
				SystemTestFunc.ErrorHandler("The num of Ads in database and the num of Ads be created on MSN don't match. " + "Num of active Ads in database: " + numAllAds + ". Num of Ads added to google: " + mads.length);
			}
		}
	}
	...
	private void verification_DeleteAds() throws Exception
	{
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.Google))
		{
			...
			if (match > 0)
			{
				SystemTestFunc.ErrorHandler("Ads are not completely deleted on google. " + "An Ad title '" + finaATitle + "' is found, while it should have been deleted.");
			}
		}
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.MSN))
		{
			...
			if (match > 0)
			{
				SystemTestFunc.ErrorHandler("Ads are not completely deleted on MSN. " + "An Ad title '" + finaATitle + "' is found, while it should have been deleted.");
			}
		}
	}
	...
	private void verification_UpdateBudget() throws Exception
	{
		...
		Double updatedBudget = jdbcTemplate.queryForObject(sql, new Object[] { SystemTestDataModel.semplestPromotionId }, Double.class);
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.Google))
		{
			...
			for (SitelinksExtension sle : gSiteLinks)
			{
				...
				for (com.google.api.adwords.v201109_1.cm.Sitelink sl : sle.getSitelinks())
				{
					...
					if ((sl.getDisplayText().equals(SystemTestDataModel.siteLink1.getLinkText())) && (sl.getDestinationUrl().equals(SystemTestDataModel.siteLink1.getLinkURL())))
					{
						match++;
					}
				}
				...
				{
					SystemTestFunc.ErrorHandler("The num of SiteLinks in database and the num of SiteLinks be refreshed on google don't match. " + "Num of SiteLinks in database: " + SystemTestDataModel.sitelinks.size() + ". Num of SiteLinks refreshed to google: " + sle.getSitelinks().length);
				}
				if (match != 1)
				{
					SystemTestFunc.ErrorHandler("SiteLinks are not refreshed correctly on google. " + "A SiteLink " + SystemTestDataModel.siteLink1.getLinkText() + " is not found on google.");
				}
			}
		}
	}
	...
	private void verification_AddKeywords() throws Exception
	{
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.Google))
		{
			...
			if (match != 1)
			{
				SystemTestFunc.ErrorHandler("Keywords are not added correctly on google. " + "An Keyword '" + findAKeyword + "' is not found.");
			}
			if (gkws.length != numAllKeywords)
			{
				// verify the num of Keywords get added
				SystemTestFunc.ErrorHandler("Not all Keywords in database are added to google. " + "Num of Keywords in database: " + numAllKeywords + ". Num of Ads added to google: " + gkws.length);
			}
		}
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.MSN))
		{
			...
			if (match != 1)
			{
				SystemTestFunc.ErrorHandler("Keywords are not added correctly on MSN. " + "An Keyword '" + findAKeyword + "' is not found.");
			}
			if (mkws.length != numAllKeywords)
			{
				// verify the num of Keywords get added
				SystemTestFunc.ErrorHandler("Not all Keywords in database are added to MSN. " + "Num of Keywords in database: " + numAllKeywords + ". Num of Ads added to MSN: " + mkws.length);
			}
		}
	}
	...
	private void verification_DeleteKeywords() throws Exception
	{
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.Google))
		{
			...
			if (match > 0)
			{
				SystemTestFunc.ErrorHandler("Keywords are not completely deleted on google. " + "A Keyword '" + findAKeyword + "' is found, while it should have been deleted.");
			}
		}
		...
		if (SystemTestDataModel.adEngineList.contains(AdEngine.MSN))
		{
			...
			if (match > 0)
			{
				SystemTestFunc.ErrorHandler("Keywords are not completely deleted on MSN. " + "A Keyword '" + findAKeyword + "' is found, while it should have been deleted.");
			}
		}
	}
	...
	@Override
	public Boolean ExecuteBidProcess(Integer PromotionID, List<AdEngine> adEngine) throws Exception
	{
