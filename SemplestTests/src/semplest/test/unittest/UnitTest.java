...
public class UnitTest
{
	...
	public static void main(String[] args)
	{
		 ...
		 * List of Tests:
		 * 
		 * - MsnCloudService Test - GoogleAdwordsService Test - SchedulerService Test - Database Test - SemplestAdengineService - KeywordsService -
		 * BiddingService
		 */
		...
		try
		{
			...
			/*
			 * Boolean useSandbox = (Boolean) configDB.configData.get("AdwordsUseSandbox"); if(useSandbox){ GoogleServiceTest googleServiceTest = new
			 * GoogleServiceTest(); numGoogleStandaloneError = googleServiceTest.Test_GoogleService_Impl(); //numGoogleServiceError =
			 * googleServiceTest.Test_getReportForAccount(); //Test only Report through ESB }
			 */
		...
		numAllErrs = numMsnStandaloneError + numMsnServiceError + numGoogleStandaloneError + numGoogleServiceError + numAdEngineStandalongError + numAdEngineServiceError + numKeywordStandaloneError + numKeywordServiceError + numBiddingStandaloneError + numBiddingServiceError + numDatabaseError;
	...
	{
		/*
		 * String host = "VMDEVWEB1"; Properties properties = System.getProperties(); properties.setProperty("mail.smtp.host", host); Session session =
		 * Session.getDefaultInstance(properties);
		 * 
		 * try{ MimeMessage message = new MimeMessage(session); message.setFrom(new InternetAddress(from)); message.addRecipient(Message.RecipientType.TO,
		 * new InternetAddress(to)); message.setSubject(subject); message.setText(msg);
		 * 
