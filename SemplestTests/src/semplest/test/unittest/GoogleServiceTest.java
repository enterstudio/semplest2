...
public class GoogleServiceTest {
	...
	public int Test_getReportForAccount(){
		...
		try{
			ArrayList<ReportObject> ret = test.getReportForAccount(new SemplestString().toSemplestString(accountID));
	...
	public int Test_GoogleService_Standalone(){		
		...
		try{
			...
			try{
				...
				Campaign cpn = test.CreateOneCampaignForAccount(accountID, campaignName, CampaignStatus.PAUSED, BudgetBudgetPeriod.DAILY, new Money(null, 10000000L));
				System.out.println("OK");	
			...
			try{
				...
				Campaign cpn1 = test.CreateOneCampaignForAccount(accountID, campaignName, CampaignStatus.PAUSED, BudgetBudgetPeriod.DAILY, new Money(null, 2050000L));
			...
			try{
				boolean ret = test.changeCampaignBudget(accountID, campaignID, new Money(null, 10550000L));
				System.out.println("OK");	
				System.out.println("successful = " + ret);
			}
			catch(Exception e){
