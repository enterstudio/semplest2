...
public class SchedulerServiceTest
{
	...
	public void TestCase1()
	{
		try
		{
			...
			// SemplestSchedulerTaskObject mailTask2 = CreateSchedulerAndTask.getSendMailTask("[SchedulerTest]Test Case #1-email 2",
			// "nan@semplest.com", "nan@semplest.com", "Expected Output: Get two emails immediately.", EmailType.PlanText.getEmailValue());
	...
	public void TestCase2()
	{
		try
		{
			...
			// SemplestSchedulerTaskObject mailTask2 = CreateSchedulerAndTask.getSendMailTask("[SchedulerTest]Test Case #2-email 2",
			// "nan@semplest.com", "nan@semplest.com", "now = " + now.toString() + "\nExpected Output: Get two emails every 10 mins.",
