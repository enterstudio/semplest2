...
public class MsnServiceTest
{
	...
	public int Test_MsnReport()
	{
		...
		try
		{
			...
			else
			{
				...
				/*
				 * for(ReportObject t: kwreport){ System.out.println("->"); System.out.println("Keyword = " + t.getKeyword());
				 * System.out.println("BidAmount = " + t.getMicroBidAmount()); System.out.println("BidMatchType = " + t.getBidMatchType());
				 * System.out.println("NumberImpressions = " + t.getNumberImpressions()); System.out.println("NumberClick = " + t.getNumberClick());
				 * System.out.println("AveragePosition = " + t.getAveragePosition()); System.out.println("QualityScore = " + t.getQualityScore());
				 * System.out.println("AverageCPC = " + t.getAverageCPC()); System.out.println("CreatedDate = " + t.getTransactionDate()); }
				 */
			}
	...
	public int Test_createAccount()
	{
		...
		try
		{
			...
			in.setSemplestString(System.currentTimeMillis() + "_msnTest");
	...
	public int Test_MsnServices_Standalone() throws Exception
	{
		...
		try
		{
			...
			if ((Boolean) SemplestConfiguration.configData.get("MSNUseSandbox"))
			{
				accountId = 10001159L;
				// customerId = 777L;
				// userId = 777L;
			...
			try
			{
				...
				{
					if (b.getState().equals("US-NY"))
						c++;
					if (b.getState().equals("US-MA"))
						c++;
					if (b.getState().equals("US-CA"))
						c++;
					if (b.getState().equals("US-FL"))
						c++;
				}
				if (c != 4)
			...
			try
			{
				...
				{
					if (t.getCity().equals("Brookline, Boston MA US"))
						c++;
					if (t.getCity().equals("Newton, Boston MA US"))
						c++;
					if (t.getCity().equals("Wellesley, Boston MA US"))
						c++;
				}
				if (c != 3)
			...
			try
			{
				...
				{
					if (m.getMetroArea().equals("Brooklyn, NY US"))
						c++;
					if (m.getMetroArea().equals("New York, NY US"))
						c++;
				}
				if (c != 2)
			...
			try
			{
				...
				System.out.println("OK");
				System.out.println("AdId = " + ad1.getId() + "; status = " + ad1.getStatus().getValue() + "; EditorialStatus = " + ad1.getEditorialStatus().getValue() + "; Type = " + ad1.getType().getValue());
				TextAd ad2 = (TextAd) ad1;
				System.out.println("Title = " + ad2.getTitle() + "; Text = " + ad2.getText() + "; DisplayUrl = " + ad2.getDisplayUrl() + "; DestinationUrl = " + ad2.getDestinationUrl());
			...
			try
			{
				...
				{
					TextAd a = (TextAd) x;
					System.out.println("Id = " + a.getId() + "; Title = " + a.getTitle() + "; Text = " + a.getText() + "; DisplayUrl = " + a.getDisplayUrl() + "; DestinationUrl = " + a.getDestinationUrl());
				}
			...
			try
			{
				...
				if (kw1 != null)
				{
					System.out.println("Id = " + kw1.getId() + "; text = " + kw1.getText());
				}
			...
			/*
			 * DateTime firstDay = new DateTime(2012,3,1,0,0,0,0); DateTime lastDay = new DateTime(2012,3,31,0,0,0,0); String ret1 =
			 * test.requestKeywordReport(1595249L, 130129414L, firstDay, lastDay, ReportAggregation.fromString(ReportAggregation._Daily));
			 */

			// getReportData
			/*
			 * Map<String, String[]> ret2 = test.getReportData(ret1, 1595249L); Set<String> keys = ret2.keySet(); Collection<String[]> values =
			 * ret2.values(); logger.info(keys.toString()); logger.info(values.toString());
			 */

			/*
			 * //getKeywordReport System.out.println("------------------------------------------------------------");
			 * System.out.println("getKeywordReport:"); try{ DateTime firstDay = new DateTime(2011,1,1,0,0,0,0); DateTime lastDay = new
			 * DateTime(2012,4,30,0,0,0,0); Long test_accountId = 1617055L; Long test_campaignId = 130140291L; ReportObject[] kwreport =
			 * test.getKeywordReport(test_accountId, test_campaignId, firstDay, lastDay, ReportAggregation.Daily); System.out.println("OK");
