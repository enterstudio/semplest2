...
public class KeywordTestPerServerThread implements Runnable {
	...
	public KeywordTestPerServerThread(int sleepsecs, String url) {
		super();
		this.sleep_time = sleepsecs * 1000;
		this.testUrl = url;
		
		try {			
			String serverName = testUrl.split("//")[1].split(":")[0];
			String reportName = serverName + "_" + testName + "_" + System.currentTimeMillis() + ".csv";
			...
			writer.append(',');
			writer.append("Sleep Time: " + sleep_time);
			writer.append('\n');
