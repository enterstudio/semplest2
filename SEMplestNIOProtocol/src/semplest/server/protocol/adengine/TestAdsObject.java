...
public class TestAdsObject
{
	...
	public void testAdEngineAdIdComparator()
	{
		...
		final AdsObject ad1 = new AdsObject(1, 2, "adTitle1_1", "adTextLine1_1", "adTextLine2_1", 1L, isDeleted, createdDate, deletedDate, AdEngine.Google);
		final AdsObject ad2 = new AdsObject(11, 22, "adTitle1_2", "adTextLine1_2", "adTextLine2_2", 2L, isDeleted, createdDate, deletedDate, AdEngine.Google);
		final AdsObject ad3 = new AdsObject(111, 222, "adTitle1_3", "adTextLine1_3", "adTextLine2_3", 3L, isDeleted, createdDate, deletedDate, AdEngine.Google);
		final AdsObject ad4 = new AdsObject(1111, 2222, "adTitle1_4", "adTextLine1_4", "adTextLine2_4", null, isDeleted, createdDate, deletedDate, AdEngine.Google);
