...
public class AdEngineBidHistoryData implements Comparable
{
	...
	public AdEngineBidHistoryData(String adEngine, String keyword, String matchType, Integer position, Double avgBid, Double avgCPC, Integer searchVol, Integer clicks, Integer impressions, Date startDate, Date endDate, Date transactionDate)
	{
		super();
		this.adEngine = adEngine;
		this.keyword = keyword;
	...
	{
		return "AdEngineBidHistoryData [adEngine = " + adEngine + ", keyword=" + keyword + ", matchType=" + matchType + ", position=" + position + ", avgBid=" + avgBid + ", avgCost=" + avgCPC + ", searchVol=" + searchVol + ", clicks=" + clicks + ", impressions=" + impressions + ", startDate="
				+ startDate + ", endDate=" + endDate + ", transactionDate=" + transactionDate + "]";
	}

	@Override
	public int hashCode()
	{ // kept transactionDate out
		final int prime = 31;
		int result = 1;
		...
		result = prime * result + ((searchVol == null) ? 0 : searchVol.hashCode());
