...
public interface ChaseOrbitalGatewayInterface extends ServiceInitialize
{
	...
	GatewayReturnObject UpdateProfileRecurringBilling(String customerProfileRefNumber, Double recurringAmount, java.util.Date startDate, int dayOfMonth) throws Exception;
