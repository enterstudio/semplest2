...
public interface SemplestAdengineServiceInterface extends ServiceInitialize
{
	...
	public abstract Boolean UpdateGeoTargeting(Integer PromotionID) throws Exception;
	...
	public abstract Boolean AddSiteLinkForAd(Integer customerID,Integer promotionID, Integer promotionAdID) throws Exception;
