...
public interface SemplestAdengineServiceInterface extends ServiceInitialize
{
	...
	// not yet implemented	
	public abstract Boolean PausePromotion(Integer customerID,Integer promotionID, List<String> adEngines) throws Exception;
	...
	public abstract Boolean UpdateAd(Integer customerID,Integer promotionID, Integer promotionAdID, List<String> adEngines) throws Exception;	
