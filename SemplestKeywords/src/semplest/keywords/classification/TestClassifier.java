...
public class TestClassifier
{
	 ...
	 * FORMAT!!) args[1] : path to the file that will contain model and instances args[2] : Number of topics args[3] : Number of Gibbs iterations
	 * args[4] : alpha value args[5] : beta value
	 * 
	 * @throws Exception
	 */
