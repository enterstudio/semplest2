...
public class vsUtils {
  ...
  public static Double cDist( Map<String,Integer> a,
  ...
  public static Map<String,Integer> cAdd( Map<String, 
      Map<String,Integer>>  wcs){
    Map<String,Integer> omap = new HashMap<String,Integer>();
  ...
  // weighted add
  public static Map<String,Integer> cAdd( Map<String, 
      Map<String,Integer>>  wcs, Map<String,Double> wts){
    Map<String,Integer> omap = new HashMap<String,Integer>();
    for( Map.Entry<String,Map<String,Integer>> wc: wcs.entrySet() ) 
      for( Map.Entry<String,Integer> e: wc.getValue().entrySet() )
  ...
  public static Map<String,Integer> cSum( Map<String, 
      Map<String,Integer>>  wcs){
    Map<String,Integer> omap = new HashMap<String,Integer>();
    for( Map.Entry<String,Map<String,Integer>> wc: wcs.entrySet() ){ 
  ...
  public static Map<String,Integer> cCombine( 
      Map<String, Map<String,Integer>> wcs, Map<String,Integer> rv){
  ...
  public static Map<String,Integer> cCombine( 
    Map<String, Map<String,Integer>> wcs, String rurl){
    String urltext = "";
    try {
  ...
  public static TreeSet sortMap( Map<String,Integer> wc ){
    TreeSet<Map.Entry<String,Integer>> tm = 
  ...
  private static void test(){
    ...
    Map<String,Map<String,Integer>> cs = 
  ...
  private static void Test(String ngramFile, String ancestor, String ref){
    ...
    Map<String,Map<String,Integer>> wcs = catUtils.family( 
  ...
  //------------
  public static String[] generateNgrams(String basePath, String extension,
      ArrayList<String> categories, String data, int numKw){
    // read in categories from file and pick out those with categories selected
    Map<String,Map<String,Integer>> wcs = new HashMap<String,Map<String,
    Integer>>();
    for(String cat : categories){
      //Building the nGramsFileName 	
      String[] subCat = cat.split("/");
      String file = basePath+subCat[1]+extension;
      Map<String,Map<String,Integer>> wcsAux = catUtils.family( 
    ...
    Long start = System.currentTimeMillis();
    Map<String,Integer> cc = cCombine( wcs, rv );
    System.out.println("Combine Categories seconds " + 
  ...
  public static void main (String[] args){
    ...
    String rngrams = "wedding+flowers flower+shops birthday+flowers" + 
    ...
    String rwords = "wedding flowers birthday " + 
      "bouquets flower delivery fruit baskets " + 
      "valentines day arrangements plants red roses" + 
      "fresh single " ;
