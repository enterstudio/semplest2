...
public class ioUtils
{
	...
	{
		List<String> arraybuf = new ArrayList<String>();
		try
		{
	...
	public static List<String> readFile(String file, int col)
	{
		List<String> arraybuf = new ArrayList<String>();
		try
		{
	...
	public static List<String[]> readCols(String file)
	{
		List<String[]> arraybuf = new ArrayList<String[]>();
		try
		{
		...
		try
		{
			...
			while ((line = r.readLine()) != null)
			{
				...
				if (cols.length >= 2)
				{
					...
					String tail = mkString(java.util.Arrays.copyOfRange(cols, 1, cols.length), " ");
					map.put(cat, tail);
				}
			}
		}
	...
	public static Map<String, String> file2Hash(String f)
	{
		Map<String, String> map = new HashMap<String, String>();
		try
		{
	...
	public static Map<String, String> loadStates(String f) throws IOException
	{
	...
	public static List<String> malletizeLine(String line)
	{
		String id = "";
		String label = "";
		String words = "";
	...
	public static List<String> line2ArrayList(String line)
	{
		String[] tokens = line.split("\\s+");
	...
	public static Map<String, List<String>> file2WordMap(String filePath)
	{
		...
		{
			List<String> tokens = line2ArrayList(line);
	...
	{
		/*
		 * String f = "/semplest/data/dmoz/all/hCounts.txt.tw"; String h = "top/sports/equestrian/breeds/spanish_horses"; Map<String,String> wcs =
		 * readWcounts(f); System.out.println( wcs.get( h ));
		 */
		try
		{
