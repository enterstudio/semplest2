...
public class SVD
{
	...
	public void printSVD()
	{
		...
		ioUtils.printMatrix(dmat);
		System.out.println("S (S)");
		ioUtils.printMatrix(smat);
		System.out.println("T (V)");
		ioUtils.printMatrix(tmat);
	}
	...
	{
		System.out.println("D (U)");
		ioUtils.printMatrix(svd[0].toDenseArray());
		System.out.println("S (S)");
		ioUtils.printMatrix(svd[1].toDenseArray());
		System.out.println("T (V)");
		ioUtils.printMatrix(svd[2].toDenseArray());
	}
