...
public class LDATrainSEMplestCache
{
	...
	{
		/*
		 * //Files to store model and instances File pipeIOModel= new File("trainedmodelallHTML700.modl"); File pipeIOInstance= new
		 * File("trainedInstancesallHTML700.inst");
		 * 
		 * //Instance LDA Topic Modelling MalletTopic lda = new MalletTopic(); double alpha=0.01; double beta=0.01; int numiter=1000;
		 * 
