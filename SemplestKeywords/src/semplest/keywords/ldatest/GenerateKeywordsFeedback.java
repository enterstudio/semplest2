...
public class GenerateKeywordsFeedback {
	...
	/**
	 * Second version of the generate Keyword program
	 * Will infer topic probabilities from URL and will find closest trained instances
	 * Then will generate a list of general categories for the user to select and will restrict the alphabets to keywords from the
