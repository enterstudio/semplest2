...
public class HtmlParserTest {
	...
	public static void main(String[] args) throws Exception {
		...
		recordData(inurl);
		/*
		HashMap<String, ArrayList<String>> data= readData("/semplest/lluis/keywordExp/urldata.txt");
		HashMap<String, Double> wCount = getWordCount(data);
		sortAndPrintMap(wCount);*/
	...
	public static void recordData(String inurl) throws Exception{
		...
		for(String ur : url){
			/*if(!urlMap.contains(ur)){
				pr.println(ur+"***************************************************************");
				try{
				printList(cleanUrlText(TextUtils.HTMLText(ur)));
				}catch(Exception e){
