...
public class LDAInferRandRemove
{
	...
	/**
	 * This program takes a saved model, removes a number of instances, retrains the model of those instances and then finds what are the closest
	 * trained instances to the ones removed. Results are saved into a file. args[0] : Path to report file args[1] : Number of instances to test
	 * 
	 * @throws Exception
	 */
