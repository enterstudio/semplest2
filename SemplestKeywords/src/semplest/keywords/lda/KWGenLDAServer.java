...
public class KWGenLDAServer
{
	...
	// Properties:
	private static final Logger logger = Logger.getLogger(KWGenLDAServer.class);
	 ...
	 */
	// ---------------------------------------------------------------------------------------------------------------------------
	public KWGenLDAServer() throws Exception
	{
	...
	public static void main(String[] args) throws Exception
	{
		...
		KWGenLDAServer kwGenerator = new KWGenLDAServer();
