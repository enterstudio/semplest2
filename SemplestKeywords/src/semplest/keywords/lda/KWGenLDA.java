...
public class KWGenLDA
{
	...
	/**
	 * This class packages the Keyword generation process using used in GenerateKeywordsMixModels for a better integration with UI. At least 30G of
	 * memory heap required to instance one of this objects;
	 * 
	 * @param args
	 * @throws Exception
	 */
	...
	private static final Logger logger = Logger.getLogger(KWGenLDA.class);
