...
public class ServicePingHandlerNIO implements Runnable
{
	...
	static final Logger logger = Logger.getLogger(ServicePingHandlerNIO.class);
	
	public ServicePingHandlerNIO(NIOServer nio, ESBServer esb, String service, String serviceOffered, int pingFrequencyMS)
	{
		this.nioServer = nio;
		this.esb = esb;
		this.client = service;
