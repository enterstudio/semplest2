...
{
	protected static Logger logger = MalletLogger.getLogger(InstanceList.class.getName());
  ...
  // This should never be set by a ClassifierTrainer, it should be used in conjunction with a Classifier's FeatureSelection
	...
	protected static class NotYetSetPipe extends Pipe	{
	...
	protected static Alphabet dictOfSize (int size)
	{
	...
	protected static String[] classNamesOfSize (int size)
	{
...
//					instance.getAlphabets()+" InstanceList: "+this.getAlphabets());
	...
	protected void prepareToRemove (Instance instance) {
		if (instWeights != null)
...
public InstanceList[] splitInOrder (double[] proportions) {
	...
	protected static final long serialVersionUID = 1;
	protected static final int CURRENT_SERIAL_VERSION = 1;
