...
public class AdGroupBuilder {
	...
	public static AdGroupBuilder create() {
		return new AdGroupBuilder(new String[] { "Search" }, BiddingModel.Keyword, null, null, null, null, null, "English", "Ad Group Name", null, null, null, PricingModel.Cpc, null, null, new PublisherCountry[] { new PublisherCountry("US", true) }, Network.OwnedAndOperatedAndSyndicatedSearch);
	}
