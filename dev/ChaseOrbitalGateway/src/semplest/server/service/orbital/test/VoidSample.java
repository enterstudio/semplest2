...
public class VoidSample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("OrderID", "1223Reverse");
            //Note: Copy a TxRefNum from a previously approved auth, and recompile this sample
            request.setFieldValue("TxRefNum", "4395E2348E2364AADC5F93451528B19F24C55389");
