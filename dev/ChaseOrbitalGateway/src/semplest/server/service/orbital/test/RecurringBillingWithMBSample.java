...
public class RecurringBillingWithMBSample {
    //Global Constants
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("IndustryType", "RC");
            ...
            request.setFieldValue("OrderID", "122003SARB");
            request.setFieldValue("Amount", "100");
            request.setFieldValue("Exp", "1209");
            request.setFieldValue("AVSzip", "33607");
            // Additional Information
            request.setFieldValue("Comments", "This is a Credit Card Recurring Auth");
            request.setFieldValue("CustomerProfileFromOrderInd", "S");
            request.setFieldValue("CustomerRefNum", "3472");
            request.setFieldValue("CustomerProfileOrderOverrideInd", "NO");
            request.setFieldValue("Status", "A");
            request.setFieldValue("MBType", "R");
            request.setFieldValue("MBOrderIdGenerationMethod", "DI");
            request.setFieldValue("MBRecurringMaxBillings", "3");
            request.setFieldValue("MBRecurringFrequency", "? * MON");
         
            
          

            //Display the request
            System.out.println("\nRecurring Billing Auth with Capture Request:\n" + request.getXML());
