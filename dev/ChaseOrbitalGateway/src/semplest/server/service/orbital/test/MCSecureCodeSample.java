...
public class MCSecureCodeSample {
    //Global Constants
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("OrderID", "122005MCSECURE");
            ...
            request.setFieldValue("Comments", "This is a test auth with MC Secure ");
            request.setFieldValue("ShippingRef", "FEDEX WB12345678 Pri 1");
            request.setFieldValue("AAV", "");

            //Display the request
            System.out.println("\nAuth MasterCard Secure Code Request:\n" + request.getXML());
