...
public class RecurringBillingRefundSample {
    //Global Constants
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("OrderID", "122003SARBR");
            request.setFieldValue("Amount", "100");
            request.setFieldValue("Exp", "1209");
            // Additional Information
            request.setFieldValue("Comments", "This is a Credit Card Recurring Refund ");

            System.out.println("\nRecurring Billing Refund Request:\n" + request.getXML());
