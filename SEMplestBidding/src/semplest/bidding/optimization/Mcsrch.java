...
public class Mcsrch {
  ...
  private static double dg = 0, dgm = 0, dginit = 0, dgtest = 0,
      ...
      fym[] = new double[1], p5 = 0, p66 = 0, stx[] = new double[1],
      sty[] = new double[1], stmin = 0, stmax = 0, width = 0, width1 = 0,
      xtrapf = 0;
   ...
   *        objective function is at least <code>maxfev</code> by the end of
   *        an iteration.
   * 
   ...
   * 1-element arrays.
   * 
   * @param stx Step at the best step obtained so far. This variable is modified
   *        by <code>mcstep</code>.
   * @param fx Function value at the best step obtained so far. This variable is
   ...
   * 
   * @param sty Step at the other endpoint of the interval of uncertainty. This
   ...
   *        minimizer has not been bracketed, then on input this variable must
   *        be set <code>false</code>. If the minimizer has been bracketed,
  ...
  public static void mcstep(double[] stx, double[] fx, double[] dx,
      ...
      double dp, boolean[] brackt, double stpmin, double stpmax, int[] info) {
    boolean bound;
