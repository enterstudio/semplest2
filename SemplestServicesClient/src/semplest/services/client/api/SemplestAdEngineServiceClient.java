...
public class SemplestAdEngineServiceClient extends ServiceRun implements SemplestAdengineServiceInterface, SchedulerTaskRunnerInterface
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		*/
		 ...
		 * 
		 * // AddAds final Integer promotionID_AddAds = 62; final List<Integer> promotionAdIs_AddAds = Arrays.asList(218); final List<String>
		 * adEngines_AddAds = Arrays.asList(AdEngine.Google.name()); client.AddAds(promotionID_AddAds, promotionAdIs_AddAds, adEngines_AddAds);
		 * 
		 * // scheduleDeleteAds final Integer customerID_scheduleDeleteAds = 12; final Integer promotionID_scheduleDeleteAds = 62; final List<Integer>
		 * promotionAdIds_scheduleDeleteAds = Arrays.asList(218); final List<String> adEngines_scheduleDeleteAds =
		 * Arrays.asList(AdEngine.Google.name()); client.scheduleDeleteAds(customerID_scheduleDeleteAds, promotionID_scheduleDeleteAds,
		 * promotionAdIds_scheduleDeleteAds, adEngines_scheduleDeleteAds);
		 * 
		 * // DeleteAds final Integer promotionID_DeleteAds = 62; final List<Integer> promotionAdIds_DeleteAds = Arrays.asList(218); final
		 * List<String> adEngines_DeleteAds = Arrays.asList(AdEngine.Google.name()); client.DeleteAds(promotionID_DeleteAds, promotionAdIds_DeleteAds,
		 * adEngines_DeleteAds);
		 * 
		 * // scheduleUpdateAds final Integer customerID_scheduleUpdateAds = 12; final Integer promotionID_scheduleUpdateAds = 62; final List<Integer>
		 * promotionAdIds_scheduleUpdateAds = Arrays.asList(218); final List<String> adEngines_scheduleUpdateAds =
		 * Arrays.asList(AdEngine.Google.name()); client.scheduleUpdateAds(customerID_scheduleUpdateAds, promotionID_scheduleUpdateAds,
		 * promotionAdIds_scheduleUpdateAds, adEngines_scheduleUpdateAds);
		 * 
		 * // UpdateAds final Integer promotionID_UpdateAds = 62; final List<Integer> promotionAdIds_UpdateAds = Arrays.asList(218); final
		 * List<String> adEngines_UpdateAds = Arrays.asList(AdEngine.Google.name()); client.UpdateAds(promotionID_UpdateAds, promotionAdIds_UpdateAds,
		 * adEngines_UpdateAds);
		 * 
		 * // scheduleUpdateGeoTargeting final Integer customerID_scheduleUpdateGeoTargeting = 12; final Integer
		 ...
		 * client.scheduleChangePromotionStartDate(customerID_scheduleChangePromotionStartDate, promotionID_scheduleChangePromotionStartDate,
		 * newStartDate_scheduleChangePromotionStartDate, adEngines_scheduleChangePromotionStartDate);
		 * 
		 * // ChangePromotionStartDate final Integer promotionID_ChangePromotionStartDate = 62; final java.util.Date
		 * newStartDate_ChangePromotionStartDate = new java.util.Date(); final List<String> adEngines_ChangePromotionStartDate =
		 * Arrays.asList(AdEngine.Google.name()); client.ChangePromotionStartDate(promotionID_ChangePromotionStartDate,
		 * newStartDate_ChangePromotionStartDate, adEngines_ChangePromotionStartDate);
		 * 
		 * // scheduleUpdateBudget final Integer customerID_scheduleUpdateBudget = 12; final Integer promotionID_scheduleUpdateBudget = 62; final
		 * Double changeInBudget_scheduleUpdateBudget = -16.75; final List<String> adEngines_scheduleUpdateBudget =
		 * Arrays.asList(AdEngine.Google.name()); client.scheduleUpdateBudget(customerID_scheduleUpdateBudget, promotionID_scheduleUpdateBudget,
		 * changeInBudget_scheduleUpdateBudget, adEngines_scheduleUpdateBudget);
		 * 
		 ...
		 * productGroupID_AddPromotionToAdEngine, promotionID_AddPromotionToAdEngine, adEngines_AddPromotionToAdEngine);
		 * 
		 * // scheduleDeleteKeywords final Integer customerID_scheduleDeleteKeywords = 12; final Integer promotionID_scheduleDeleteKeywords = 62;
		 * final List<Integer> keywordIds_scheduleDeleteKeywords = Arrays.asList(12095); final List<String> adEngines_scheduleDeleteKeywords =
		 * Arrays.asList(AdEngine.Google.name()); client.scheduleDeleteKeywords(customerID_scheduleDeleteKeywords, promotionID_scheduleDeleteKeywords,
		 * keywordIds_scheduleDeleteKeywords, adEngines_scheduleDeleteKeywords);
		 * 
		 * // DeleteKeywords final Integer promotionID_DeleteKeywords = 62; final List<Integer> keywordIds_DeleteKeywords = Arrays.asList(37); final
		 * List<String> adEngines_DeleteKeywords = Arrays.asList(AdEngine.Google.name()); client.DeleteKeywords(promotionID_DeleteKeywords,
		 * keywordIds_DeleteKeywords, adEngines_DeleteKeywords);
		 * 
		 * // scheduleRefreshSiteLinks final Integer customerID_scheduleRefreshSiteLinks = 12; final Integer promotionID_scheduleRefreshSiteLinks =
		 * 62; final List<String> adEngines_scheduleRefreshSiteLinks = Arrays.asList(AdEngine.Google.name());
		 * client.scheduleRefreshSiteLinks(customerID_scheduleRefreshSiteLinks, promotionID_scheduleRefreshSiteLinks,
		 * adEngines_scheduleRefreshSiteLinks);
		 * 
		 * // RefreshSiteLinks final Integer promotionID_RefreshSiteLinksForAd = 62; final List<String> adEngines_RefreshSiteLinksForAd =
		 * Arrays.asList(AdEngine.Google.name()); client.RefreshSiteLinks(promotionID_RefreshSiteLinksForAd, adEngines_RefreshSiteLinksForAd);
		 * 
		 * // schedulePauseProductGroups final Integer customerID_schedulePauseProductGroups = 12; final List<Integer>
		 * productGroupIds_schedulePauseProductGroups = Arrays.asList(76); final List<String> adEngines_schedulePauseProductGroups =
		 * Arrays.asList(AdEngine.Google.name()); client.schedulePauseProductGroups(customerID_schedulePauseProductGroups,
		 * productGroupIds_schedulePauseProductGroups, adEngines_schedulePauseProductGroups);
		 * 
		 * // PauseProductGroups final List<Integer> productGroupIds_PauseProductGroups = Arrays.asList(76); final List<String>
		 * adEngines_PauseProductGroups = Arrays.asList(AdEngine.Google.name()); client.PauseProductGroups(productGroupIds_PauseProductGroups,
		 * adEngines_PauseProductGroups);
		 * 
		 * // scheduleUnpausePromotion final Integer customerID_scheduleUnpausePromotion = 12; final Integer promotionID_scheduleUnpausePromotion =
		 * 62; final List<String> adEngines_scheduleUnpausePromotion = Arrays.asList(AdEngine.Google.name());
		 * client.scheduleUnpausePromotion(customerID_scheduleUnpausePromotion, promotionID_scheduleUnpausePromotion,
		 * adEngines_scheduleUnpausePromotion);
		 * 
		 * // UnpausePromotion final Integer promotionID_UnpausePromotion = 62; final List<String> adEngines_UnpausePromotion =
		 * Arrays.asList(AdEngine.Google.name()); client.UnpausePromotion(promotionID_UnpausePromotion, adEngines_UnpausePromotion);
		 * 
		 * // scheduleUnpausePromotion final Integer customerID_scheduleAddKeywords = 12; final Integer promotionID_scheduleAddKeywords = 62; final
		 * List<Integer> keywordIds_scheduleAddKeywords = Arrays.asList(12241, 12242); final List<String> adEngines_scheduleAddKeywords =
		 * Arrays.asList(AdEngine.Google.name()); client.scheduleAddKeywords(customerID_scheduleAddKeywords, promotionID_scheduleAddKeywords,
		 * keywordIds_scheduleAddKeywords, adEngines_scheduleAddKeywords);
		 * 
		 * // UnpausePromotion final Integer promotionID_AddKeywords = 62; final List<String> adEngines_AddKeywords =
		 * Arrays.asList(AdEngine.Google.name()); final List<Integer> keywordIds_AddKeywords = Arrays.asList(12241, 12242);
		 * client.AddKeywords(promotionID_AddKeywords, keywordIds_AddKeywords, adEngines_AddKeywords);
		 * 
		 * // scheduleAddNegativeKeywords final Integer customerID_scheduleAddNegativeKeywords = 12; final Integer
		 * promotionID_scheduleAddNegativeKeywords = 62; final KeywordIdRemoveOppositePair pair1_scheduleAddNegativeKeywords = new
		 * KeywordIdRemoveOppositePair(12241, false); final KeywordIdRemoveOppositePair pair2_scheduleAddNegativeKeywords = new
		 * KeywordIdRemoveOppositePair(12242, false); final List<KeywordIdRemoveOppositePair> keywordIdRemoveOppositePairs_scheduleAddNegativeKeywords
		 * = new ArrayList<KeywordIdRemoveOppositePair>();
		 * keywordIdRemoveOppositePairs_scheduleAddNegativeKeywords.add(pair1_scheduleAddNegativeKeywords);
		 * keywordIdRemoveOppositePairs_scheduleAddNegativeKeywords.add(pair2_scheduleAddNegativeKeywords); final List<String>
		 * adEngines_scheduleAddNegativeKeywords = Arrays.asList(AdEngine.Google.name());
		 * client.scheduleAddNegativeKeywords(customerID_scheduleAddNegativeKeywords, promotionID_scheduleAddNegativeKeywords,
		 * keywordIdRemoveOppositePairs_scheduleAddNegativeKeywords, adEngines_scheduleAddNegativeKeywords);
		 * 
		 * // AddNegativeKeywords final Integer promotionID_AddNegativeKeywords = 62; final KeywordIdRemoveOppositePair pair1_AddNegativeKeywords =
		 * new KeywordIdRemoveOppositePair(12241, true); final KeywordIdRemoveOppositePair pair2_scheduleAddNegativeKeywords = new
		 * KeywordIdRemoveOppositePair(12242, false); final List<KeywordIdRemoveOppositePair> keywordIdRemoveOppositePairs_AddNegativeKeywords = new
		 * ArrayList<KeywordIdRemoveOppositePair>(); keywordIdRemoveOppositePairs_AddNegativeKeywords.add(pair1_AddNegativeKeywords);
		 ...
		 * keywordIds_scheduleDeleteNegativeKeywords, adEngines_scheduleDeleteNegativeKeywords);
		 * 
		 * // UnpausePromotion final Integer promotionID_DeleteNegativeKeywords = 62; final List<String> adEngines_DeleteNegativeKeywords =
		 * Arrays.asList(AdEngine.Google.name()); final List<Integer> keywordIds_DeleteNegativeKeywords = Arrays.asList(12241, 12242);
		 ...
		 * 
		 * // scheduleAddPromotionToAdEngine - MSN final Integer customerID_scheduleAddPromotionToAdEngineMSN = 12; final Integer
		 * productGroupID_scheduleAddPromotionToAdEngineMSN = 76; final Integer promotionID_scheduleAddPromotionToAdEngineMSN = 62; final
		 * ArrayList<String> adEngines_scheduleAddPromotionToAdEngineMSN = new ArrayList<String>(Arrays.asList(new String[]{AdEngine.MSN.name()}));
		 * client.scheduleAddPromotionToAdEngine(customerID_scheduleAddPromotionToAdEngineMSN, productGroupID_scheduleAddPromotionToAdEngineMSN,
		 * promotionID_scheduleAddPromotionToAdEngineMSN, adEngines_scheduleAddPromotionToAdEngineMSN);
		 * 
		 * // AddPromotionToAdEngine - MSN final Integer customerID_AddPromotionToAdEngineMSN = 1418; final Integer
		 * productGroupID_AddPromotionToAdEngineMSN = 248; final Integer promotionID_AddPromotionToAdEngineMSN = 251; final ArrayList<String>
		 * adEngines_AddPromotionToAdEngineMSN = new ArrayList<String>(Arrays.asList(AdEngine.MSN.name()));
		 * client.AddPromotionToAdEngine(customerID_AddPromotionToAdEngineMSN, productGroupID_AddPromotionToAdEngineMSN,
		 * promotionID_AddPromotionToAdEngineMSN, adEngines_AddPromotionToAdEngineMSN);
		 * 
		 * // scheduleAddAds - MSN final Integer customerID_ScheduleAddAds = 12; final Integer promotionID_ScheduleAddAds = 62; final List<Integer>
		 * promotionAdIds_ScheduleAddAds = Arrays.asList(218); final List<String> adEngines_ScheduleAddAds = Arrays.asList(AdEngine.MSN.name());
		 * client.scheduleAddAds(customerID_ScheduleAddAds, promotionID_ScheduleAddAds, promotionAdIds_ScheduleAddAds, adEngines_ScheduleAddAds);
		 * 
		 * // AddAds - MSN final Integer promotionID_AddAds = 62; final List<Integer> promotionAdIs_AddAds = Arrays.asList(218); final List<String>
		 * adEngines_AddAds = Arrays.asList(AdEngine.MSN.name()); client.AddAds(promotionID_AddAds, promotionAdIs_AddAds, adEngines_AddAds);
		 * 
		 * // scheduleDeleteAds - MSN final Integer customerID_scheduleDeleteAds = 12; final Integer promotionID_scheduleDeleteAds = 62; final
		 * List<Integer> promotionAdIds_scheduleDeleteAds = Arrays.asList(218); final List<String> adEngines_scheduleDeleteAds =
		 * Arrays.asList(AdEngine.MSN.name()); client.scheduleDeleteAds(customerID_scheduleDeleteAds, promotionID_scheduleDeleteAds,
		 * promotionAdIds_scheduleDeleteAds, adEngines_scheduleDeleteAds);
		 * 
		 * // DeleteAds - MSN final Integer promotionID_DeleteAds = 62; final List<Integer> promotionAdIds_DeleteAds = Arrays.asList(218); final
		 * List<String> adEngines_DeleteAds = Arrays.asList(AdEngine.MSN.name()); client.DeleteAds(promotionID_DeleteAds, promotionAdIds_DeleteAds,
		 * adEngines_DeleteAds);
		 * 
		 * // scheduleUpdateAds - MSN final Integer customerID_scheduleUpdateAds = 12; final Integer promotionID_scheduleUpdateAds = 62; final
		 * List<Integer> promotionAdIds_scheduleUpdateAds = Arrays.asList(218); final List<String> adEngines_scheduleUpdateAds =
		 * Arrays.asList(AdEngine.MSN.name()); client.scheduleUpdateAds(customerID_scheduleUpdateAds, promotionID_scheduleUpdateAds,
		 * promotionAdIds_scheduleUpdateAds, adEngines_scheduleUpdateAds);
		 * 
		 * // UpdateAds - MSN final Integer promotionID_UpdateAds = 62; final List<Integer> promotionAdIds_UpdateAds = Arrays.asList(218); final
		 * List<String> adEngines_UpdateAds = Arrays.asList(AdEngine.MSN.name()); client.UpdateAds(promotionID_UpdateAds, promotionAdIds_UpdateAds,
		 * adEngines_UpdateAds);
		 * 
		 * // scheduleUpdateGeoTargeting - MSN final Integer customerID_scheduleUpdateGeoTargeting = 12; final Integer
		 * promotionID_scheduleUpdateGeoTargeting = 62; final List<String> adEngines_scheduleUpdateGeoTargeting = Arrays.asList(AdEngine.MSN.name());
		 * client.scheduleUpdateGeoTargeting(customerID_scheduleUpdateGeoTargeting, promotionID_scheduleUpdateGeoTargeting,
		 * adEngines_scheduleUpdateGeoTargeting);
		 * 
		 * // UpdateGeoTargeting - MSN final Integer promotionID_UpdateGeoTargeting = 62; final List<String> adEngines_UpdateGeoTargeting =
		 * Arrays.asList(AdEngine.MSN.name()); client.UpdateGeoTargeting(promotionID_UpdateGeoTargeting, adEngines_UpdateGeoTargeting);
		 * 
		 * // scheduleChangePromotionStartDate - MSN final Integer customerID_scheduleChangePromotionStartDate = 12; final Integer
		 * promotionID_scheduleChangePromotionStartDate = 62; final java.util.Date newStartDate_scheduleChangePromotionStartDate = new
		 * java.util.Date(); final List<String> adEngines_scheduleChangePromotionStartDate = Arrays.asList(AdEngine.MSN.name());
		 * client.scheduleChangePromotionStartDate(customerID_scheduleChangePromotionStartDate, promotionID_scheduleChangePromotionStartDate,
		 * newStartDate_scheduleChangePromotionStartDate, adEngines_scheduleChangePromotionStartDate);
		 * 
		 * // ChangePromotionStartDate - MSN final Integer promotionID_ChangePromotionStartDate = 62; final java.util.Date
		 * newStartDate_ChangePromotionStartDate = new java.util.Date(); final List<String> adEngines_ChangePromotionStartDate =
		 * Arrays.asList(AdEngine.MSN.name()); client.ChangePromotionStartDate(promotionID_ChangePromotionStartDate,
		 * newStartDate_ChangePromotionStartDate, adEngines_ChangePromotionStartDate);
		 * 
		 * // scheduleUpdateBudget - MSN final Integer customerID_scheduleUpdateBudget = 12; final Integer promotionID_scheduleUpdateBudget = 62;
		 * final Double changeInBudget_scheduleUpdateBudget = -16.75; final List<String> adEngines_scheduleUpdateBudget =
		 * Arrays.asList(AdEngine.MSN.name()); client.scheduleUpdateBudget(customerID_scheduleUpdateBudget, promotionID_scheduleUpdateBudget,
		 * changeInBudget_scheduleUpdateBudget, adEngines_scheduleUpdateBudget);
		 * 
		 * // UpdateBudget - MSN final Integer promotionID_UpdateBudget = 62; final Double changeInBudget_UpdateBudget = -5.25; final List<String>
		 * adEngines_UpdateBudget = Arrays.asList(AdEngine.MSN.name()); client.UpdateBudget(promotionID_UpdateBudget, changeInBudget_UpdateBudget,
		 * adEngines_UpdateBudget);
		 * 
		 * // schedulePausePromotion - MSN final Integer customerID_schedulePausePromotion = 12; final Integer promotionID_schedulePausePromotion =
		 * 62; final List<String> adEngines_schedulePausePromotion = Arrays.asList(AdEngine.MSN.name());
		 ...
		 * 
		 * // PausePromotion - MSN final Integer promotionID_PausePromotion = 62; final List<String> adEngines_PausePromotion =
		 * Arrays.asList(AdEngine.MSN.name()); client.PausePromotion(promotionID_PausePromotion, adEngines_PausePromotion);
		 */
	}
	...
	public Boolean scheduleDeleteNegativeKeywords(Integer customerID, Integer promotionID, List<Integer> keywordIds, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem Scheduling the Delete of Negative Keywords for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "], and KeywordIds [" + keywordIds + "]";
	...
	public Boolean scheduleAddNegativeKeywords(Integer customerID, Integer promotionID, List<KeywordIdRemoveOppositePair> keywordIdRemoveOppositePairs, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Add Negative Keywords for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "], KeywordIdRemoveOppositePairs [" + keywordIdRemoveOppositePairs + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleAddKeywords(Integer customerID, Integer promotionID, List<Integer> keywordIds, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Add Keywords for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "], KeywordIds [" + keywordIds + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleAddAds(Integer customerID, Integer promotionID, List<Integer> promotionAdIds, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Add Ads for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "], PromotionAdIds [" + promotionAdIds + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleDeleteAds(Integer customerID, Integer promotionID, List<Integer> promotionAdIds, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Delete Ads for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "], PromotionAdIds [" + promotionAdIds + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleUpdateAds(Integer customerID, Integer promotionID, List<Integer> promotionAdIds, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Update Ads for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "], PromotionAdIds [" + promotionAdIds + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleUpdateGeoTargeting(Integer customerID, Integer PromotionID, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Update Geo Targets for CustomerID [" + customerID + "], PromotionID [" + PromotionID + "], AdEngines [" + adEngines + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	@Override
	public Boolean scheduleChangePromotionStartDate(Integer customerID, Integer promotionID, java.util.Date newStartDate, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Change Promotion Start Date for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], NewStartDate [" + newStartDate + "], AdEngines [" + adEngines + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleUpdateBudget(Integer customerID, Integer promotionID, Double changeInBudget, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Update Budget for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], ChangeInBudget [" + changeInBudget + "], AdEngines [" + adEngines + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean schedulePausePromotion(Integer customerID, Integer promotionID, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Pause Promotion for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleUnpausePromotion(Integer customerID, Integer promotionID, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Un-Pause Promotion for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleDeleteKeywords(Integer customerID, Integer promotionID, List<Integer> keywordIds, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Delete Keywords for CustomerID [" + customerID + "], PromotionID [" + promotionID + "], AdEngines [" + adEngines + "], KeywordIds [" + keywordIds + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean scheduleRefreshSiteLinks(Integer customerID, Integer promotionID, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Refresh Site Links for CustomerID [" + customerID + "], PromotionID [" + promotionID + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	public Boolean schedulePauseProductGroups(Integer customerID, List<Integer> productGroupIds, List<AdEngine> adEngines) throws Exception
	{
		...
		{
			final String errMsg = "Problem scheduling Pause Product Group for CustomerID [" + customerID + "], ProductGroupIds [" + productGroupIds + "], AdEngines [" + adEngines + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
	...
	@Override
	public Boolean scheduleAddPromotionToAdEngine(Integer customerID, Integer productGroupID, Integer PromotionID, List<AdEngine> adEngineList) throws Exception
	{
	...
	public Boolean scheduleExecuteBidProcess(Integer promotionID, ArrayList<String> adEngineList) throws Exception
	{
		final String methodName = "scheduleAddPromotionToAdEngine";
		final HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("promotionID", Integer.toString(promotionID));
		...
		{
			final String errMsg = "Problem scheduling Pause Product Group for PromotionID [" + promotionID + "], AdEngines [" + adEngineList + "]";
			logger.error(errMsg, e);
			throw new Exception(errMsg, e);
		}
	}
