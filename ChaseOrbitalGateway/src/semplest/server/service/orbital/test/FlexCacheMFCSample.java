...
public class FlexCacheMFCSample {
    //Global Constants
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("FlexAction", "REDEMPTIONCOMPLETION");
            
            // the TxRefNum number comes from the response of a previously run
            // transaction
            request.setFieldValue("TxRefNum", "4395DF3A3A82141E3FDC4A914F32E3F83A725330");
            request.setFieldValue("Amount", "100");

			//flexcache elements (both elements default to N)
            request.setFieldValue("FlexAutoAuthInd", "Y");
            request.setFieldValue("FlexPartialRedemptionInd", "Y");

            //Display the request
            System.out.println("\nFlex Cache MFC Request:\n" + request.getXML());
