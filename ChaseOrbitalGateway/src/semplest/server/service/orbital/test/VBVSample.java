...
public class VBVSample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("OrderID", "122003SAVBV");
            ...
            request.setFieldValue("Comments", "Test Authorize Request");
            request.setFieldValue("ShippingRef", "FEDEX WB12345678 Pri 1");
            //Verified By Visa Fields
            request.setFieldValue("XID", "123456789312345678801234567=");
            request.setFieldValue("CAVV", "123456789312345678801234567=");

            //Display the request
            System.out.println("\nVerified By Visa Auth Request:\n" + request.getXML());
