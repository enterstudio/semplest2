...
public class EUDDSample {
    ...
    public static void main(String[] args) {
        ...
        try {
	      ...
	      request.setFieldValue("EUDDCountryCode","DE");
       	request.setFieldValue("EUDDBankSortCode","1234567890");

            // Additional Information
            request.setFieldValue("Comments", "This is Java SDK EUDD Test");
            request.setFieldValue("ShippingRef", "FEDEX WB12345678 Pri 1");
            request.setFieldValue("CardBrand", "ED");
