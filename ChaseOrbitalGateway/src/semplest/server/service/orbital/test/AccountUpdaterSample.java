...
public class AccountUpdaterSample {
    //Global Constants
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request = new Request(RequestIF.ACCOUNT_UPDATER);
            ...
            request.setFieldValue("CustomerRefNum", "1234");
            request.setFieldValue("CustomerProfileAction", "C");
            request.setFieldValue("ScheduledDate", "01012011");
            //Display the request
