...
public class TextAdBuilder {
	...
	public TextAd build() {
		TextAd ta = new TextAd();
		ta.setDestinationUrl(this._destinationUrl);
		ta.setDisplayUrl(this._displayUrl);
		ta.setEditorialStatus(this._editorialStatus);
		ta.setId(this._id);
		ta.setStatus(this._status);
		ta.setText(this._text);
		ta.setTitle(this._title);
		ta.setType(this._type);
		return ta;
	}
