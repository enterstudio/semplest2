...
public class CampaignBuilder {
	...
	public Campaign build() {
		...
		cp.setBudgetType(this._budgetType);
		cp.setConversionTrackingEnabled(this._conversionTrackingEnabled);
		cp.setDailyBudget(this._dailyBudget);
		cp.setDaylightSaving(this._daylightSaving);
		cp.setDescription(this._description);
		cp.setId(this._id);
		cp.setMonthlyBudget(this._monthlyBudget);
		cp.setName(this._name);
		cp.setStatus(this._status);
		cp.setTimeZone(this._timeZone);
		return cp;
	}
}