...
public class MSNAdcenterServiceClient extends ServiceRun implements MsnAdcenterServiceInterface, SchedulerTaskRunnerInterface
{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			//getAccountById
			Account ret = test.getAccountById(1595249L);
			...
			*/
			...
			//getAccountById
			Account ret = test.getAccountById(01L);
			
		}
		//catch (SemplestError e)	{
		//	e.printStackTrace();
		//}
		catch (SemplestError e){
			e.printStackTrace();
	...
	public MSNAdcenterServiceClient()
	{
	...
	*/
	...
	@Override
	public Account getAccountById(Long accountId) throws SemplestError, Exception
	{
	...
	public Long createCampaign(Long accountId, String campaignName, BudgetLimitType budgetType, double dailyBudget, double monthlyBudget, CampaignStatus CampaignStatus)
			throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignName", campaignName);
		jsonHash.put("budgetType", gson.toJson(budgetType));
	...
	@Override
	public Campaign getCampaignById(Long accountId, Long campaignId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
	...
	@Override
	public Campaign[] getCampaignsByAccountId(Long accountId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		String json = gson.toJson(jsonHash);
	...
	@Override
	public void pauseCampaignById(Long accountId, Long campaignId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignId", Long.toString(campaignId.longValue()));
	...
	@Override
	public void pauseCampaignsByAccountId(Long accountId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		String json = gson.toJson(jsonHash);
	...
	@Override
	public void resumeCampaignById(Long accountId, Long campaignId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignId", Long.toString(campaignId.longValue()));
	...
	@Override
	public void deleteCampaignById(Long accountId, Long campaignId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignId", Long.toString(campaignId.longValue()));
	...
	@Override
	public void updateCampaignBudget(Long accountId, Long campaignId, BudgetLimitType budgetType, double dailyBudget, double monthlyBudget) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignId", Long.toString(campaignId.longValue()));
	...
	@Override
	public void setCampaignStateTargets(Long accountId, long customerId, Long campaignId, List<String> states) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		String stateslist = "";
	...
	@Override
	public void deleteCampaignTargets(Long accountId, long customerId, Long campaignId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("customerId", Long.toString(customerId));
	...
	@Override
	public Target getCampaignTargets(Long accountId, long customerId, Long campaignId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("customerId", Long.toString(customerId));
	...
	@Override
	public long createAdGroup(Long accountId, Long campaignId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignId", Long.toString(campaignId.longValue()));
	...
	@Override
	public AdGroup[] getAdGroupsByCampaignId(Long accountId, Long campaignId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignId", Long.toString(campaignId.longValue()));
	...
	@Override
	public AdGroup getAdGroupById(Long accountId, Long campaignId, Long adGroupId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignId", Long.toString(campaignId.longValue()));
	...
	@Override
	public void deleteAdGroupById(Long accountId, Long campaignId, Long adGroupId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("campaignId", Long.toString(campaignId.longValue()));
	...
	@Override
	public void setAdGroupStateTargets(Long accountId, long customerId, Long adGroupId, List<String> states) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		String stateslist = "";
		for (int i = 0; i < states.size()-1; i++){
	...
	@Override
	public void setAdGroupCityTargets(Long accountId, long customerId, Long adGroupId, List<String> cities) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		String citylist = "";
	...
	@Override
	public void setAdGroupMetroAreaTargets(Long accountId, long customerId, long msnAdGroupId, List<String> metroTargets) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
	...
	@Override
	public void deleteAdGroupTargets(Long accountId, long customerId, Long adGroupId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("customerId", Long.toString(customerId));
	...
	@Override
	public Target getAdGroupTargets(Long accountId, long customerId, Long adGroupId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("customerId", Long.toString(customerId));
	...
	@Override
	public long createAd(Long accountId, Long adGroupId, String title, String text, String displayUrl, String destinationUrl) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	@Override
	public Ad getAdById(Long accountId, Long adGroupId, long adId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	@Override
	public Ad[] getAdsByAdGroupId(Long accountId, Long adGroupId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	@Override
	public void pauseAdById(Long accountId, Long adGroupId, long adId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	@Override
	public void resumeAdById(Long accountId, Long adGroupId, long adId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	@Override
	public void deleteAdById(Long accountId, Long adGroupId, long adId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	public long createKeyword(Long accountId, Long adGroupId, String text, Bid broadMatchBid, Bid contentMatchBid, Bid exactMatchBid,
			Bid phraseMatchBid) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
	...
	@Override
	public Keyword getKeywordById(Long accountId, Long adGroupId, long keywordId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	@Override
	public Keyword[] getKeywordByAdGroupId(Long accountId, Long adGroupId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));		
	...
	public void updateKeywordBidsByIds(Long accountId, Long adGroupId, long[] keywordId, Bid[] broadMatchBid, Bid[] contentMatchBid,
			Bid[] exactMatchBid, Bid[] phraseMatchBid) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
	...
	@Override
	public void pauseKeywordById(Long accountId, Long adGroupId, long keywordId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	@Override
	public void deleteKeywordById(Long accountId, Long adGroupId, long keywordId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
		jsonHash.put("adGroupId", Long.toString(adGroupId.longValue()));
	...
	@Override
	public void deleteKeywordsById(Long accountId, Long adGroupId, long[] keywordIds) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
	...
	@Override
	public KeywordEstimatedPosition[] getKeywordEstimateByBids(Long accountId, String[] keywords, Money bid) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		String keywordsList = "";
	...
	@Override
	public Map<String, String[]> getReportData(String reportId, Long accountId) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		...
		try{
			ret = protocolJson.getHashMapFromJson(returnData);
		}
		catch(Exception e){
			throw new SemplestError("getReportData", e.getMessage());
		}
	...
	@Override
	public String requestCampaignReport(Long accountId, Long campaignId, int daysInReport, ReportAggregation aggregation) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
	...
	@Override
	public String requestKeywordReport(Long accountId, Long campaignId, DateTime firstDay, DateTime lastDay, ReportAggregation aggregation) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		String aggregationStr = gson.toJson(aggregation);
		jsonHash.put("accountId", Long.toString(accountId.longValue()));
	...
	@Override
	public MsnManagementIds createAccount(SemplestString name) throws SemplestError
	{
	...
	@Override
	public long[] createKeywords(Long accountId, Long adGroupId, Keyword... keywords) throws SemplestError
	{
		HashMap<String, String> jsonHash = new HashMap<String, String>();
		String keywordsList = "";
		for (int i = 0; i < keywords.length-1; i++){
	...
	public KeywordEstimate[] getKeywordEstimateByBids(Long accountId, String[] keywords, double[] broadMatchBids, double[] exactMatchBids,
			double[] phraseMatchBids) throws SemplestError
	{
		// TODO Auto-generated method stub
		return null;
	}
	@Override
	public void initializeService(String input) throws SemplestError
	{
		// TODO Auto-generated method stub
		
	}
	@Override
	public TaskOutput RunTask(String method, String jsonParameters, String optionalTimeoutMS, TaskOutput previousTaskOutput) throws SemplestError
	{
