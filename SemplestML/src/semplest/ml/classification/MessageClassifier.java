...
public class MessageClassifier implements Serializable {
  ...
  public String doMessageClassify(String messageName, String modelName,
      String classValue) {
    try {
      // Get message file
      ...
      if (classValue.length() != 0) {
        ...
        classifierRet = messageCl.classifyMessage(message.toString());
      }
  ...
  public static void main(String[] options) throws Exception{
    ...
    mc.doMessageClassify("data/mytraining/training-0001",
        "model/training", "satire");
    mc.doMessageClassify("data/mytraining/training-0001",
        "model/training", "");
