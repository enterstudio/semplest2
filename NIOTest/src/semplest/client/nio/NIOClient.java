...
public class NIOClient implements Runnable
{
	...
	static final Logger logger = Logger.getLogger(NIOClient.class);

	public NIOClient(String uri, String port) throws IOException
	{
	...
	public void run()
	{
		while (true)
		{
			try
			{
				...
				final int numKeys = this.selector.select();
				logger.debug("Num of keys received from select(): " + numKeys);
	...
	private void handleResponse(SocketChannel socketChannel, byte[] data, int numRead) throws IOException
	{
		...
		NIOResponseHandler handler = (NIOResponseHandler) this.rspHandlers.get(socketChannel);
