...
namespace SemplestModel
{
    public partial class PromotionAdEngineSelected
    {
        ...
        public virtual int PromotionAdEngineSelectedPK
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.PromotionAdEngineSelecteds.Contains(this))
            {
                previousValue.PromotionAdEngineSelecteds.Remove(this);
            }
    
            if (AdvertisingEngine != null)
            {
                if (!AdvertisingEngine.PromotionAdEngineSelecteds.Contains(this))
                {
                    AdvertisingEngine.PromotionAdEngineSelecteds.Add(this);
                }
        ...
        private void FixupPromotion(Promotion previousValue)
        {
            ...
            if (Promotion != null)
            {
                if (!Promotion.PromotionAdEngineSelecteds.Contains(this))
                {
                    Promotion.PromotionAdEngineSelecteds.Add(this);
                }
