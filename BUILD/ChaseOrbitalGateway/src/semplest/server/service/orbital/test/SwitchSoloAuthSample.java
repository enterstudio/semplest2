...
public class SwitchSoloAuthSample {
    //Global Constants
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("MerchantID", "193979");
            request.setFieldValue("BIN", "000001");
            request.setFieldValue("OrderID", "122003SASS");
            request.setFieldValue("AccountNum", "6759184500000131104");
            request.setFieldValue("Amount", "100");
            request.setFieldValue("Exp", "1209");
            request.setFieldValue("Comments", "Test SwitchSolo Authorize Request");
            request.setFieldValue("ShippingRef", "FEDEX WB12345678 Pri 1");
            
            // Debit Card Information
            request.setFieldValue("CurrencyCode", "826");
            request.setFieldValue("CardBrand", "SW");
            request.setFieldValue("DebitCardStartDate", "0695");
            request.setFieldValue("DebitCardIssueNum", "1");

            //Display the request
            System.out.println("\nSwitch Solo Auth Request:\n" + request.getXML());
