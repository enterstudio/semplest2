/* $Header:   //sslmfile2/public/pvcs/PaymentechSDK/Java/JavaSDK/samples/PinlessDebitAuthCaptureSample.java-arc   1.6   Dec 15 2009 12:38:54   rbhaskha  $ */
...
public class PinlessDebitAuthCaptureSample {
    //Global Constants
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Basic Auth Fields
		request.setFieldValue("IndustryType","IV");
		request.setFieldValue("MessageType","AC");
		//Note: BIN – 000001 only
		request.setFieldValue("BIN","000001");
		request.setFieldValue("MerchantID","123456789012");
		request.setFieldValue("TerminalID","001");
		request.setFieldValue("CardBrand","DP");
		request.setFieldValue("AccountNum","5999012345678905");
		request.setFieldValue("Exp","1205");
		request.setFieldValue("CurrencyCode","840");
		request.setFieldValue("CurrencyExponent","2");
		request.setFieldValue("AVSzip","33123-1234");
		request.setFieldValue("AVSaddress1","12345 AUTHORIZATION STREET NTH");
		request.setFieldValue("AVSaddress2","SUITE 123");
		request.setFieldValue("AVScity","NEW PORT RICHEY FL");
		request.setFieldValue("AVSstate","FL");
		request.setFieldValue("AVSname","JOE SMITH");
		request.setFieldValue("AVScountryCode","US");
		request.setFieldValue("OrderID","1234567890123456");
		request.setFieldValue("Amount","000000005500");
		request.setFieldValue("Comments","This is an AVS/CVV2 auth request");
		request.setFieldValue("BillerReferenceNumber","12345687");

            //Display the request
            System.out.println("\nPinless Debit  Auth Request:\n" + request.getXML());
...
/* $Log:   //sslmfile2/public/pvcs/PaymentechSDK/Java/JavaSDK/samples/PinlessDebitAuthCaptureSample.java-arc  $
// 
//    Rev 1.6   Dec 15 2009 12:38:54   rbhaskha
// added comments
// 
//    Rev 1.5   Dec 15 2009 12:36:56   rbhaskha
// changed the BIN to 000001
// 
//    Rev 1.4   Dec 14 2009 16:42:28   rbhaskha
// removed the configurator
// 
//    Rev 1.3   Apr 30 2008 11:22:56   rbhaskha
// fix for 6.1
// 
//    Rev 1.2   Jan 18 2007 17:00:02   rbhaskha
// Chaned the CC number for PinlessDebit
// 
//    Rev 1.1   Jan 08 2007 08:40:22   rbhaskha
// Chnaged the version number from 5.0.0 to 6.0.0
// 
//    Rev 1.0   Nov 28 2006 14:21:12   rbhaskha
// Initial revision.
*/
