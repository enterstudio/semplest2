...
public class Pcard2AuthSample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("OrderID", "122003SAPCARD");
            request.setFieldValue("AccountNum", "4055011111111111");
            request.setFieldValue("Amount", "100");
            request.setFieldValue("Exp", "1209");
            // PCard2 Entries
            request.setFieldValue("Tax", "10");
            request.setFieldValue("TaxInd", "1");
            request.setFieldValue("PCOrderNum", "12345");
            request.setFieldValue("PCDestZip", "33100");
            // AVS Information
            ...
            // Common Optional
            request.setFieldValue("Comments", "This is a test P-Card Auth Capture Request");
