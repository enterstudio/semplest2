...
public class ProfileSample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("CustomerBin", "000001");
            request.setFieldValue("CustomerMerchantID", "041756");
            request.setFieldValue("CustomerName", "Jon Smith II");
            request.setFieldValue("CustomerAddress1", "345 His Way");
            request.setFieldValue("CustomerAddress2", "Suite 3");
            request.setFieldValue("CustomerCity", "Palm Harbor");
            request.setFieldValue("CustomerState", "FL");
            request.setFieldValue("CustomerZIP", "33605");
            request.setFieldValue("CustomerEmail", "jonsmith@hisway.com");
            request.setFieldValue("CustomerPhone", "81356285410");
            ...
            request.setFieldValue("OrderDefaultAmount", "2800");
            request.setFieldValue("CustomerAccountType", "CC");
            request.setFieldValue("CCAccountNum", "4055011111111111");
            request.setFieldValue("CCExpireDate", "0809");
        ...
        System.out.println(">>>>> CustomerRefNum=" + response.getValue("CustomerRefNum"));
    }
}
