...
public class ECPAuthSample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("OrderID", "122005SAECP");
            ...
            request.setFieldValue("BankAccountType", "C");
            
            // Additional Information
            request.setFieldValue("Comments", "This is an ECP Authorization Test");
