...
public class ECPForceDepositSample {
    //Global Constants
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setFieldValue("OrderID", "122005SAECPFORCE");
            request.setFieldValue("Amount", "100");
            request.setFieldValue("Comments", "This is a test ECP Forced Deposit");
            
            // set the prior auth to initiate the offline transaction
            TemplateIF prior = request.getComplexRoot(RequestIF.PRIOR_AUTH_ID);
            prior.setFieldValue ("PriorAuthID", "12345");
            
            // ECP Data
            request.setFieldValue("CardBrand", "EC");
            request.setFieldValue("CheckDDA", "8965237845");
            request.setFieldValue("BCRtNum", "031200730");
            
            // AVS Information
            request.setFieldValue("AVSname", "Jon Smith");

            //Log the request
            System.out.println("\nECP Force Deposit Request:\n" + request.getXML());
