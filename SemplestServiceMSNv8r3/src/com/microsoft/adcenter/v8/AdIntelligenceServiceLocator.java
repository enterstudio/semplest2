...
public class AdIntelligenceServiceLocator extends org.apache.axis.client.Service implements com.microsoft.adcenter.v8.AdIntelligenceService {
    ...
    private java.lang.String BasicHttpBinding_IAdIntelligenceService_address = "https://adcenterapi.microsoft.com/Api/Advertiser/V8/AdIntelligence/AdIntelligenceService.svc";
    ...
    public com.microsoft.adcenter.v8.IAdIntelligenceService getBasicHttpBinding_IAdIntelligenceService() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.adcenter.v8.IAdIntelligenceService getBasicHttpBinding_IAdIntelligenceService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.microsoft.adcenter.v8.BasicHttpBinding_IAdIntelligenceServiceStub _stub = new com.microsoft.adcenter.v8.BasicHttpBinding_IAdIntelligenceServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.adcenter.v8.IAdIntelligenceService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.adcenter.v8.BasicHttpBinding_IAdIntelligenceServiceStub _stub = new com.microsoft.adcenter.v8.BasicHttpBinding_IAdIntelligenceServiceStub(new java.net.URL(BasicHttpBinding_IAdIntelligenceService_address), this);
                _stub.setPortName(getBasicHttpBinding_IAdIntelligenceServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "AdIntelligenceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "BasicHttpBinding_IAdIntelligenceService"));
        }
