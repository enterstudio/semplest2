...
public class OptimizerServiceLocator extends org.apache.axis.client.Service implements com.microsoft.adcenter.v8.OptimizerService {
    ...
    private java.lang.String BasicHttpBinding_IOptimizerService_address = "https://adcenterapi.microsoft.com/Api/Advertiser/V8/Optimizer/OptimizerService.svc";
    ...
    public com.microsoft.adcenter.v8.IOptimizerService getBasicHttpBinding_IOptimizerService() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.adcenter.v8.IOptimizerService getBasicHttpBinding_IOptimizerService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.microsoft.adcenter.v8.BasicHttpBinding_IOptimizerServiceStub _stub = new com.microsoft.adcenter.v8.BasicHttpBinding_IOptimizerServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.adcenter.v8.IOptimizerService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.adcenter.v8.BasicHttpBinding_IOptimizerServiceStub _stub = new com.microsoft.adcenter.v8.BasicHttpBinding_IOptimizerServiceStub(new java.net.URL(BasicHttpBinding_IOptimizerService_address), this);
                _stub.setPortName(getBasicHttpBinding_IOptimizerServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "OptimizerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "BasicHttpBinding_IOptimizerService"));
        }
