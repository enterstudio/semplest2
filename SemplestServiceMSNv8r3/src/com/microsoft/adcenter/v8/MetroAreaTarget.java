...
public class MetroAreaTarget  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.MetroAreaTargetBid[] bids;

    public MetroAreaTarget() {
    }

    public MetroAreaTarget(
           com.microsoft.adcenter.v8.MetroAreaTargetBid[] bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.adcenter.v8.MetroAreaTargetBid[] getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.adcenter.v8.MetroAreaTargetBid[] bids) {
        this.bids = bids;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "MetroAreaTarget"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "MetroAreaTargetBid"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "MetroAreaTargetBid"));
