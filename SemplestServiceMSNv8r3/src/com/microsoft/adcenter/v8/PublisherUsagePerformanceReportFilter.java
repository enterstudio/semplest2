...
public class PublisherUsagePerformanceReportFilter  implements java.io.Serializable {
    ...
    /**
     * Gets the languageAndRegion value for this PublisherUsagePerformanceReportFilter.
     * 
    ...
    /**
     * Sets the languageAndRegion value for this PublisherUsagePerformanceReportFilter.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "PublisherUsagePerformanceReportFilter"));
