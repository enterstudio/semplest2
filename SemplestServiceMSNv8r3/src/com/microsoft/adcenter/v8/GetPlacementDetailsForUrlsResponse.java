...
public class GetPlacementDetailsForUrlsResponse  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.PlacementDetail[][] placementDetails;

    public GetPlacementDetailsForUrlsResponse() {
    }

    public GetPlacementDetailsForUrlsResponse(
           com.microsoft.adcenter.v8.PlacementDetail[][] placementDetails) {
     ...
     */
    public com.microsoft.adcenter.v8.PlacementDetail[][] getPlacementDetails() {
        return placementDetails;
    }
     ...
     */
    public void setPlacementDetails(com.microsoft.adcenter.v8.PlacementDetail[][] placementDetails) {
        this.placementDetails = placementDetails;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", ">GetPlacementDetailsForUrlsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("placementDetails");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "PlacementDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "ArrayOfPlacementDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "ArrayOfPlacementDetail"));
