...
public class ApiFaultDetail  extends com.microsoft.adapi.ApplicationFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "ApiFaultDetail"));
