...
public class BusinessInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the id value for this BusinessInfo.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this BusinessInfo.
     * 
     * @param id
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "BusinessInfo"));
