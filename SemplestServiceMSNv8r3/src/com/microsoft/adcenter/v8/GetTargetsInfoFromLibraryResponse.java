...
public class GetTargetsInfoFromLibraryResponse  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.TargetInfo[] targetsInfo;

    public GetTargetsInfoFromLibraryResponse() {
    }

    public GetTargetsInfoFromLibraryResponse(
           com.microsoft.adcenter.v8.TargetInfo[] targetsInfo) {
     ...
     * @return targetsInfo
     */
    public com.microsoft.adcenter.v8.TargetInfo[] getTargetsInfo() {
        return targetsInfo;
    }
     ...
     * @param targetsInfo
     */
    public void setTargetsInfo(com.microsoft.adcenter.v8.TargetInfo[] targetsInfo) {
        this.targetsInfo = targetsInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", ">GetTargetsInfoFromLibraryResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("targetsInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "TargetsInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "TargetInfo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "TargetInfo"));
