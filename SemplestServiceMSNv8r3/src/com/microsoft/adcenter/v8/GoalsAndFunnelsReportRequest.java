...
public class GoalsAndFunnelsReportRequest  extends com.microsoft.adcenter.v8.ReportRequest  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.NonHourlyReportAggregation aggregation;

    private com.microsoft.adcenter.v8.GoalsAndFunnelsReportColumn[] columns;

    private com.microsoft.adcenter.v8.GoalsAndFunnelsReportFilter filter;
    ...
    public GoalsAndFunnelsReportRequest(
           ...
           com.microsoft.adcenter.v8.GoalsAndFunnelsReportColumn[] columns,
           com.microsoft.adcenter.v8.GoalsAndFunnelsReportFilter filter,
     ...
     * @return columns
     */
    public com.microsoft.adcenter.v8.GoalsAndFunnelsReportColumn[] getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.microsoft.adcenter.v8.GoalsAndFunnelsReportColumn[] columns) {
        this.columns = columns;
    }
     ...
     * @param filter
     */
    public void setFilter(com.microsoft.adcenter.v8.GoalsAndFunnelsReportFilter filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "GoalsAndFunnelsReportRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "GoalsAndFunnelsReportColumn"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "GoalsAndFunnelsReportColumn"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filter");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "Filter"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "GoalsAndFunnelsReportFilter"));
