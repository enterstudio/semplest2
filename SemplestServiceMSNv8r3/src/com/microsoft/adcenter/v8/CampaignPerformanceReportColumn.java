...
public class CampaignPerformanceReportColumn implements java.io.Serializable {
    ...
    public static final CampaignPerformanceReportColumn ImpressionLostToRelevancePercent = new CampaignPerformanceReportColumn(_ImpressionLostToRelevancePercent);
    public static final CampaignPerformanceReportColumn ImpressionLostToOthersPercent = new CampaignPerformanceReportColumn(_ImpressionLostToOthersPercent);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "CampaignPerformanceReportColumn"));
    }
    /**
