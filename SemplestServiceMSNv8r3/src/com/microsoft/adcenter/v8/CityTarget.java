...
public class CityTarget  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.CityTargetBid[] bids;

    public CityTarget() {
    }

    public CityTarget(
           com.microsoft.adcenter.v8.CityTargetBid[] bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.adcenter.v8.CityTargetBid[] getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.adcenter.v8.CityTargetBid[] bids) {
        this.bids = bids;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "CityTarget"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "CityTargetBid"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "CityTargetBid"));
