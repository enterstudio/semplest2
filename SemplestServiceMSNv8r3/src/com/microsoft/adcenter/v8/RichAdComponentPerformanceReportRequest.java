...
public class RichAdComponentPerformanceReportRequest  extends com.microsoft.adcenter.v8.ReportRequest  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.NonHourlyReportAggregation aggregation;

    private com.microsoft.adcenter.v8.RichAdComponentPerformanceReportColumn[] columns;

    private com.microsoft.adcenter.v8.RichAdComponentPerformanceReportFilter filter;
    ...
    public RichAdComponentPerformanceReportRequest(
           ...
           com.microsoft.adcenter.v8.RichAdComponentPerformanceReportColumn[] columns,
           com.microsoft.adcenter.v8.RichAdComponentPerformanceReportFilter filter,
     ...
     * @return columns
     */
    public com.microsoft.adcenter.v8.RichAdComponentPerformanceReportColumn[] getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.microsoft.adcenter.v8.RichAdComponentPerformanceReportColumn[] columns) {
        this.columns = columns;
    }
     ...
     * @param filter
     */
    public void setFilter(com.microsoft.adcenter.v8.RichAdComponentPerformanceReportFilter filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "RichAdComponentPerformanceReportRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "RichAdComponentPerformanceReportColumn"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "RichAdComponentPerformanceReportColumn"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filter");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "Filter"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "RichAdComponentPerformanceReportFilter"));
