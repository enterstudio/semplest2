...
public class AddAdExtensionsResponse  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.AdExtensionIdentity[] adExtensionIdentities;

    public AddAdExtensionsResponse() {
    }

    public AddAdExtensionsResponse(
           com.microsoft.adcenter.v8.AdExtensionIdentity[] adExtensionIdentities) {
     ...
     */
    public com.microsoft.adcenter.v8.AdExtensionIdentity[] getAdExtensionIdentities() {
        return adExtensionIdentities;
    }
     ...
     */
    public void setAdExtensionIdentities(com.microsoft.adcenter.v8.AdExtensionIdentity[] adExtensionIdentities) {
        this.adExtensionIdentities = adExtensionIdentities;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", ">AddAdExtensionsResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("adExtensionIdentities");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "AdExtensionIdentities"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "AdExtensionIdentity"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "AdExtensionIdentity"));
