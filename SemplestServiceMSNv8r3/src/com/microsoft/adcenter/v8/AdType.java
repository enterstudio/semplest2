...
public class AdType implements java.io.Serializable {
    ...
    public static final java.lang.String _RichSearch = "RichSearch";
    public static final AdType Text = new AdType(_Text);
    public static final AdType Image = new AdType(_Image);
    public static final AdType Mobile = new AdType(_Mobile);
    public static final AdType RichSearch = new AdType(_RichSearch);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "AdType"));
    }
    /**
