...
public class AdPerformanceReportFilter  implements java.io.Serializable {
    ...
    /**
     * Gets the languageAndRegion value for this AdPerformanceReportFilter.
     * 
    ...
    /**
     * Sets the languageAndRegion value for this AdPerformanceReportFilter.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "AdPerformanceReportFilter"));
