...
public class ReportTime  implements java.io.Serializable {
    ...
    private com.microsoft.adcenter.v8.ReportTimePeriod predefinedTime;
    ...
    public ReportTime(
           ...
           com.microsoft.adcenter.v8.ReportTimePeriod predefinedTime) {
     ...
     */
    public void setPredefinedTime(com.microsoft.adcenter.v8.ReportTimePeriod predefinedTime) {
        this.predefinedTime = predefinedTime;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "ReportTime"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "ReportTimePeriod"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
