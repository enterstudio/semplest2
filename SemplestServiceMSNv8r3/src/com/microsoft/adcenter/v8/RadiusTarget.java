...
public class RadiusTarget  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.RadiusTargetBid[] bids;

    public RadiusTarget() {
    }

    public RadiusTarget(
           com.microsoft.adcenter.v8.RadiusTargetBid[] bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.adcenter.v8.RadiusTargetBid[] getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.adcenter.v8.RadiusTargetBid[] bids) {
        this.bids = bids;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "RadiusTarget"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "RadiusTargetBid"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "RadiusTargetBid"));
