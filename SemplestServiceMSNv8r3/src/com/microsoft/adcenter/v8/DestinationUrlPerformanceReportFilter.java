...
public class DestinationUrlPerformanceReportFilter  implements java.io.Serializable {
    ...
    /**
     * Gets the languageAndRegion value for this DestinationUrlPerformanceReportFilter.
     * 
    ...
    /**
     * Sets the languageAndRegion value for this DestinationUrlPerformanceReportFilter.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "DestinationUrlPerformanceReportFilter"));
