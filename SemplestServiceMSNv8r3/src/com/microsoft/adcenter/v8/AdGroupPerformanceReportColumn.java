...
public class AdGroupPerformanceReportColumn implements java.io.Serializable {
    ...
    public static final AdGroupPerformanceReportColumn LanguageAndRegion = new AdGroupPerformanceReportColumn(_LanguageAndRegion);
    ...
    public static final AdGroupPerformanceReportColumn ImpressionLostToRelevancePercent = new AdGroupPerformanceReportColumn(_ImpressionLostToRelevancePercent);
    public static final AdGroupPerformanceReportColumn ImpressionLostToOthersPercent = new AdGroupPerformanceReportColumn(_ImpressionLostToOthersPercent);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "AdGroupPerformanceReportColumn"));
    }
    /**
