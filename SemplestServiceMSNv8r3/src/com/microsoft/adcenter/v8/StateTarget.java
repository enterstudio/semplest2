...
public class StateTarget  implements java.io.Serializable {
    private com.microsoft.adcenter.v8.StateTargetBid[] bids;

    public StateTarget() {
    }

    public StateTarget(
           com.microsoft.adcenter.v8.StateTargetBid[] bids) {
           this.bids = bids;
    }
     ...
     * @return bids
     */
    public com.microsoft.adcenter.v8.StateTargetBid[] getBids() {
        return bids;
    }
     ...
     * @param bids
     */
    public void setBids(com.microsoft.adcenter.v8.StateTargetBid[] bids) {
        this.bids = bids;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "StateTarget"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "StateTargetBid"));
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("https://adcenter.microsoft.com/v8", "StateTargetBid"));
