...
public class GetRequestToManageAccountsResponse  implements java.io.Serializable {
    private com.microsoft.adcenter.api.customermanagement.Entities.ManageAccountsRequest manageAccountsRequest;

    public GetRequestToManageAccountsResponse() {
    }
    ...
    /**
     * Gets the manageAccountsRequest value for this GetRequestToManageAccountsResponse.
     * 
    ...
    /**
     * Sets the manageAccountsRequest value for this GetRequestToManageAccountsResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetRequestToManageAccountsResponse)) return false;
        GetRequestToManageAccountsResponse other = (GetRequestToManageAccountsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetRequestToManageAccountsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement", ">GetRequestToManageAccountsResponse"));
