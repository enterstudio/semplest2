...
public class UpdateUserResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the lastModifiedTime value for this UpdateUserResponse.
     * 
    ...
    /**
     * Sets the lastModifiedTime value for this UpdateUserResponse.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement", ">UpdateUserResponse"));
