...
public class AddAccountRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the account value for this AddAccountRequest.
     * 
     * @return account
     */
    ...
    /**
     * Sets the account value for this AddAccountRequest.
     * 
     * @param account
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement", ">AddAccountRequest"));
