...
public class AccountType implements java.io.Serializable {
    ...
    public static final AccountType Advertiser = new AccountType(_Advertiser);
    public static final AccountType Publisher = new AccountType(_Publisher);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement/Entities", "AccountType"));
    }
    /**
