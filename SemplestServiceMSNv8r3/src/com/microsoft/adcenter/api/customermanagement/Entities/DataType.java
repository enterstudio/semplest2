...
public class DataType implements java.io.Serializable {
    ...
    public static final DataType Xml = new DataType(_Xml);
    public static final DataType Pdf = new DataType(_Pdf);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement/Entities", "DataType"));
    }
    /**
