...
public class UpdateAccountRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the account value for this UpdateAccountRequest.
     * 
     * @return account
     */
    ...
    /**
     * Sets the account value for this UpdateAccountRequest.
     * 
     * @param account
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement", ">UpdateAccountRequest"));
