...
public class SendRequestToManageAccountsRequest  implements java.io.Serializable {
    private com.microsoft.adcenter.api.customermanagement.Entities.ManageAccountsRequest manageAccountsRequest;

    public SendRequestToManageAccountsRequest() {
    }
    ...
    /**
     * Gets the manageAccountsRequest value for this SendRequestToManageAccountsRequest.
     * 
    ...
    /**
     * Sets the manageAccountsRequest value for this SendRequestToManageAccountsRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SendRequestToManageAccountsRequest)) return false;
        SendRequestToManageAccountsRequest other = (SendRequestToManageAccountsRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SendRequestToManageAccountsRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement", ">SendRequestToManageAccountsRequest"));
