...
public class CustomerManagementServiceLocator extends org.apache.axis.client.Service implements com.microsoft.adcenter.api.customermanagement.CustomerManagementService {
    ...
    private java.lang.String BasicHttpBinding_ICustomerManagementService_address = "https://sharedservices.adcenterapi.microsoft.com/Api/CustomerManagement/v8/CustomerManagementService.svc";
    ...
    public com.microsoft.adcenter.api.customermanagement.ICustomerManagementService getBasicHttpBinding_ICustomerManagementService() throws javax.xml.rpc.ServiceException {
    ...
    public com.microsoft.adcenter.api.customermanagement.ICustomerManagementService getBasicHttpBinding_ICustomerManagementService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.microsoft.adcenter.api.customermanagement.BasicHttpBinding_ICustomerManagementServiceStub _stub = new com.microsoft.adcenter.api.customermanagement.BasicHttpBinding_ICustomerManagementServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.microsoft.adcenter.api.customermanagement.ICustomerManagementService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.microsoft.adcenter.api.customermanagement.BasicHttpBinding_ICustomerManagementServiceStub _stub = new com.microsoft.adcenter.api.customermanagement.BasicHttpBinding_ICustomerManagementServiceStub(new java.net.URL(BasicHttpBinding_ICustomerManagementService_address), this);
                _stub.setPortName(getBasicHttpBinding_ICustomerManagementServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement", "CustomerManagementService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customermanagement", "BasicHttpBinding_ICustomerManagementService"));
        }
