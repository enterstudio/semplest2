...
public class GetDisplayInvoicesResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the invoices value for this GetDisplayInvoicesResponse.
     * 
     * @return invoices
     */
    ...
    /**
     * Sets the invoices value for this GetDisplayInvoicesResponse.
     * 
     * @param invoices
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/customerbilling", ">GetDisplayInvoicesResponse"));
